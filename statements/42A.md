...
![](images/42A_1.png)
 ...
 litres (thus, there should be *a*~1~ ·*x*, ..., *a*~*n*~ ·*x* litres of corresponding ingredients mixed for some non-negative *x*). In the kitchen Volodya found out that he has *b*~1~, ..., *b*~*n*~ litres of these ingredients at his disposal correspondingly. In order to correct his algebra mistakes he ought to cook as much soup as possible in a *V* litres volume pan (which means the amount of soup cooked can be between 0 and *V* litres). What is the volume of borscht Volodya will cook ultimately?
