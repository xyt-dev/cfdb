...
The fourth line contains *m* integers *b*~*i*~ (1 ≤ *b*~*i*~ ≤ 2·10^9^) — the number of manapoints to use the *i*-th spell of the first type.
...
The sixth line contains *k* integers *d*~*i*~ (1 ≤ *d*~*i*~ ≤ 2·10^9^) — the number of manapoints required to use the *i*-th spell of the second type. It's guaranteed that *d*~*i*~ are not decreasing, i.e. *d*~*i*~ ≤ *d*~*j*~ if *i* < *j*.
