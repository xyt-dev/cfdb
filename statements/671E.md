...
Next line contains *n* - 1 integers. The *i*-th of them is *w*~*i*~ (1 ≤ *w*~*i*~ ≤ 10^9^) — the length of the road between city *i* and *i* + 1.

Next line contains *n* integers. The *i*-th of them is *g*~*i*~ (0 ≤ *g*~*i*~ ≤ 10^9^) — the amount of gas you receive every time you enter city *i*.
