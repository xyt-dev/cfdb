...
The first line contains an integer *n* (2 ≤ *n* ≤ 100) — the number of soldiers. Then follow the heights of the soldiers in their order in the circle — *n* space-separated integers *a*~1~, *a*~2~, ..., *a*~*n*~ (1 ≤ *a*~*i*~ ≤ 1000). The soldier heights are given in a clockwise or counterclockwise direction.
