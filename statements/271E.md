...
The first line contains two integers *n*, *m* (1 ≤ *n* ≤ 10^5^, 2 ≤ *m* ≤ 10^9^). The second line contains the sequence of integers *a*~1~, *a*~2~, ..., *a*~*n*~ (2 ≤ *a*~*i*~ ≤ 10^9^). Note, that the numbers in the sequence can coincide.
