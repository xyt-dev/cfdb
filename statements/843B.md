...
After each query of type ? read two integers *value*~*i*~ and *next*~*i*~ (0 ≤ *value*~*i*~ ≤ 10^9^,  - 1 ≤ *next*~*i*~ ≤ *n*, *next*~*i*~ ≠ 0).
...
In the next *n* lines print the description of the elements of the list: in the *i*-th line print two integers *value*~*i*~ and *next*~*i*~ (0 ≤ *value*~*i*~ ≤ 10^9^,  - 1 ≤ *next*~*i*~ ≤ *n*, *next*~*i*~ ≠ 0).
