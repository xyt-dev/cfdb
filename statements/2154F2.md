...
This is the hard version of the problem. The difference between the versions is that in this version, $n \le 10^6$. You can hack only if you solved all versions of this problem.
