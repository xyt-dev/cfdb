...
The first line contains two integers *n* and *q* (1 ≤ *n* ≤ 10^5^; 1 ≤ *q* ≤ 500). The second line contains *n* integers: *v*~1~, *v*~2~, ..., *v*~*n*~ (|*v*~*i*~| ≤ 10^5^). The third line contains *n* integers: *c*~1~, *c*~2~, ..., *c*~*n*~ (1 ≤ *c*~*i*~ ≤ *n*).

The following *q* lines contain the values of the constants *a* and *b* for queries. The *i*-th of these lines contains two integers *a*~*i*~ and *b*~*i*~ (|*a*~*i*~|, |*b*~*i*~| ≤ 10^5^).
