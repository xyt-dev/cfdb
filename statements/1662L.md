...
The second line contains $n$ integers $t_1, \ldots, t_n$ ($1 \le t_i \le 10^9$) — the times of the kicks in the match. The sequence of times is guaranteed to be strictly increasing, i.e., $t_1 \lt t_2 \lt \cdots \lt t_n$.
