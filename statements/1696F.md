...
However, the tree was lost in an accident. Fortunately, Fishingprince still remembers some information about the tree. More specifically, for every triple of integers $x,y,z$ ($1\le x \lt y\le n$, $1\le z\le n$) he remembers whether $d(x,z)=d(y,z)$ or not.
...
- there are at most $2$ test cases that have $n \gt 50$;
- there are at most $5$ test cases that have $n \gt 20$.
