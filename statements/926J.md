...
The *i*-th of the next *n* lines contains two integers *l*~*i*~ and *r*~*i*~ (1 ≤ *l*~*i*~ < *r*~*i*~ ≤ 10^9^) — the coordinates of the left and the right ends of the *i*-th segment. The segments are listed in the order they are added on the white line.
