...
The first line of each test case contains two integers $n$ and $m$ ($1 \le n \le \color{red}{2 \cdot 10^5}$, $0 \le m \color{red}{\le} \min(10^6, \frac{n(n+1)}{2})$), representing the length of the array $a$ you need to construct and the number of restrictions, respectively.
