...
The first line contains three integers $n$, $m_1$ and $m_2$ ($1 \le n \le 10^5$, $0 \le m_1, m_2 \lt n$) — the number of nodes and the number of initial edges in Mocha's forest and Diana's forest.
