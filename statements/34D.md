...
The first line contains three space-separated integers *n*, *r*~1~, *r*~2~ (2 ≤ *n* ≤ 5·10^4^, 1 ≤ *r*~1~ ≠ *r*~2~ ≤ *n*) — amount of cities in Berland, index of the old capital and index of the new one, correspondingly.
