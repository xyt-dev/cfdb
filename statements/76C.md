...
The first line of the input contains three integer numbers *N* (1 ≤ *N* ≤ 200 000) — length of the genome of base organism, *K* (1 ≤ *K* ≤ 22) — the maximal index of gene type in the genome and *T* (1 ≤ *T* ≤ 2·10^9^) — maximal allowable risk of disease occurence. The second line contains the genome of the given organism. It is a string of the first *K* capital English letters having length *N*.
