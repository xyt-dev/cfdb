...
Each of the next *m* lines contains two integers *x*~*i*~, *p*~*i*~ (1 ≤ *x*~*i*~ ≤ *d* - 1, 1 ≤ *p*~*i*~ ≤ 10^6^) — the position and cost of gas at the *i*-th gas station. It is guaranteed that the positions of the gas stations are distinct.
