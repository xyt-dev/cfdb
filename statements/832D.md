...
In the first example on the first day if *s* = 1, *f* = 2, *t* = 3, Misha would go on the route 1

![](images/832D_1.png)

 2, and Grisha would go on the route 3
...
In the second examle if *s* = 1, *f* = 3, *t* = 2, Misha would go on the route 1
