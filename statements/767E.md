...
The second line contains a sequence of integers *c*~1~, *c*~2~, ..., *c*~*n*~ (1 ≤ *c*~*i*~ ≤ 10^5^) — the amounts of money in rubles which Arseny is going to spend for each of the following days.

The third line contains a sequence of integers *w*~1~, *w*~2~, ..., *w*~*n*~ (1 ≤ *w*~*i*~ ≤ 10^5^) — the cashier's dissatisfaction coefficients for each of the following days.
