...
The second line contains an integer *n* (1 ≤ *n* ≤ 10^5^) — the number of queries. Then *n* lines follow: the *i*-th line contains the string *x*~*i*~ — the string for the *i*-th query. The total length of *x*~*i*~ is less than or equal to 10^6^ characters.
