...
The first line contains one integer *n* (1 ≤ *n* ≤ 100) — the number of known events. Then follow *n* lines containing two integers *l*~*i*~ and *r*~*i*~ each (1 ≤ *l*~*i*~ ≤ *r*~*i*~ ≤ 10^7^) — the earliest acceptable date and the latest acceptable date of the *i*-th event.
