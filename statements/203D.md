...
We'll say that the ball hit the door when its coordinate *y* was equal to 0. Thus the coordinates of the spot are point (*x*~0~, 0, *z*~0~), where 0 ≤ *x*~0~ ≤ *a*, 0 ≤ *z*~0~ ≤ *b*. To hit the ball, Valera steps away from the door at distance *m* and puts the ball in the center of the corridor at point

![](images/203D_1.png)

. After the hit the ball flies at speed (*v*~*x*~, *v*~*y*~, *v*~*z*~). This means that if the ball has coordinates (*x*, *y*, *z*), then after one second it will have coordinates (*x* + *v*~*x*~, *y* + *v*~*y*~, *z* + *v*~*z*~).
