...
The first line of input contains a positive integer number *n* (3 ≤ *n* ≤ 10^5^) — the number of elements in array *a*. The second line contains *n* positive integer numbers *a*~*i*~ (1 ≤ *a*~*i*~ ≤ 10^9^) — the elements of a given array.
