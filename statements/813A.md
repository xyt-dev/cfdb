...
The first line contains one integer *n* (1 ≤ *n* ≤ 1000) — the number of problems. The second line contains *n* integers *a*~*i*~ (1 ≤ *a*~*i*~ ≤ 10^5^) — the time Pasha needs to solve *i*th problem.

The third line contains one integer *m* (0 ≤ *m* ≤ 1000) — the number of periods of time when the website is working. Next *m* lines represent these periods. *j*th line contains two numbers *l*~*j*~ and *r*~*j*~ (1 ≤ *l*~*j*~ < *r*~*j*~ ≤ 10^5^) — the starting and the ending moment of *j*th period.
