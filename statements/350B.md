...
- Objects with numbers *v*~1~, *v*~2~, ..., *v*~*k* - 1~ are mountains and the object with number *v*~*k*~ is the hotel.
- For any integer *i* (1 ≤ *i* < *k*), there is exactly one ski track leading from object *v*~*i*~. This track goes to object *v*~*i* + 1~.
