...
The first line of each test case contains two integers $n$ and $k$ ($1 \le k \lt n \le 2 \cdot 10^5$) — the number of barrels and the number of pourings you can make.
