...
The first line contains integer *n* (1 ≤ *n* ≤ 10^5^) — the number of stone piles. The second line contains *n* space-separated integers: *a*~1~, *a*~2~, ..., *a*~*n*~ (1 ≤ *a*~*i*~ ≤ 10^9^) — the initial sizes of the stone piles.

The third line contains integer *q* (1 ≤ *q* ≤ 10^5^) — the number of queries. The last line contains *q* space-separated integers *k*~1~, *k*~2~, ..., *k*~*q*~ (1 ≤ *k*~*i*~ ≤ 10^5^) — the values of number *k* for distinct queries. Note that numbers *k*~*i*~ can repeat.
