...
Each of the next *n* lines contains *m* integers *c*~*ij*~ (1 ≤ *c*~*ij*~ ≤ 10^9^) — the cost of the dinner in the restaurant on the intersection of the *i*-th street and the *j*-th avenue.
