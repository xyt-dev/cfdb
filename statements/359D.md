...
- there is integer *j* (*l* ≤ *j* ≤ *r*), such that all integers *a*~*l*~, *a*~*l* + 1~, ..., *a*~*r*~ are divisible by *a*~*j*~;
...
The second line contains *n* space-separated integers *a*~1~, *a*~2~, ..., *a*~*n*~ (1 ≤ *a*~*i*~ ≤ 10^6^).
