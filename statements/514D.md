...
Next *n* lines follow describing the droids. Each line contains *m* integers *a*~1~, *a*~2~, ..., *a*~*m*~ (0 ≤ *a*~*i*~ ≤ 10^8^), where *a*~*i*~ is the number of details of the *i*-th type for the respective robot.
