...
The first line of the standard input stream contains two integers $n$ and $k$ ($3 \le n \le 1500$, $2 \le k \lt n$) — the number of nodes in the tree and the value of $k$.
