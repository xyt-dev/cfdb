...
- for given node *v* and integer value *x*, increase all *a*~*i*~ in the subtree of node *v* by value *x*
- for given node *v*, find the number of prime numbers *p* less than *m*, for which there exists a node *u* in the subtree of *v* and a non-negative integer value *k*, such that *a*~*u*~ = *p* + *m*·*k*.
...
The second line consists of *n* integers *a*~*i*~ (0 ≤ *a*~*i*~ ≤ 10^9^) — initial values of the nodes.
