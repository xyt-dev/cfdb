...
The first line contains integers *n* and *m* (1 ≤ *n* ≤ 2·10^6^, 1 ≤ *m* ≤ 2·10^5^) — the number of bytes (memory cells) and the number of instructions in Polycarpus's code. Then *m* lines follow, each line contains a pair of integers *a*~*i*~, *l*~*i*~ (1 ≤ *a*~*i*~ ≤ *n*, 1 ≤ *l*~*i*~ ≤ *n* - *a*~*i*~ + 1).
