...
*n* lines follow, each of them contains *n* integers. The *j*-th number in the *i*-th of them denotes *a*~*i*, *j*~ (1 ≤ *a*~*i*, *j*~ ≤ 10^9^ or *a*~*i*, *j*~ = 0), the number in the *i*-th row and *j*-th column of the magic grid. If the corresponding cell is empty, *a*~*i*, *j*~ will be equal to 0. Otherwise, *a*~*i*, *j*~ is positive.
