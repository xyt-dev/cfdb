...
The first line contains integer *n* (1  ≤ *n*  ≤ 80), showing how many participants we have. Each of the next *n* lines contains our predictions, the *i*-th line contains a pair of integers *l*~*i*~, *r*~*i*~ (0 ≤ *l*~*i*~ < *r*~*i*~ ≤ 10^9^) as the distributed interval for participant *i*.
