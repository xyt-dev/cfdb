...
The only line of the input contains six integers $n$, $a_1$, $x$, $y$, $m$ and $k$ ($1 \le n \le 10^7$; $0 \le a_1, x, y \lt m$; $2 \le m \le 998244353$; $1 \le k \le 5$).
