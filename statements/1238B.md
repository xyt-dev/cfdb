...
- if $y \lt c$, then the monster is pushed $r$ units to the left, so its current coordinate becomes $y - r$;
- if $y \gt c$, then the monster is pushed $r$ units to the right, so its current coordinate becomes $y + r$.
