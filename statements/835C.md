...
The next *q* lines contain the views description. The *i*-th from these lines contains five integers *t*~*i*~, *x*~1*i*~, *y*~1*i*~, *x*~2*i*~, *y*~2*i*~ (0 ≤ *t*~*i*~ ≤ 10^9^, 1 ≤ *x*~1*i*~ < *x*~2*i*~ ≤ 100, 1 ≤ *y*~1*i*~ < *y*~2*i*~ ≤ 100) — the moment of the *i*-th view and the coordinates of the viewed rectangle.
