...
![](images/847K_3.png)
 ...
 "BerBank", then he payed *a* + *b* + *a* = 2*a* + *b* burles. From the BerBank he arrived to the University, where he made transshipment to the other bus and departed to the BerMall. Then he walked to the University and returned to the BerBank by bus.
