...
- Doubles health of the creature (*hp*~*i*~ := *hp*~*i*~·2);
- Assigns value of health of the creature to its damage (*dmg*~*i*~ := *hp*~*i*~).
...
The *i*-th of the next *n* lines contain two number *hp*~*i*~ and *dmg*~*i*~ (1 ≤ *hp*~*i*~, *dmg*~*i*~ ≤ 10^9^) — description of the *i*-th creature.
