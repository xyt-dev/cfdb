...
Next *n* lines contain the descriptions of the contests. The *i*-th line contains two integers *s*~*i*~ and *f*~*i*~ (1 ≤ *s*~*i*~ < *f*~*i*~ ≤ 10^9^) — the coordinate of the start and the coordinate of the finish on the *i*-th competition.
