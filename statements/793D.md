...
The *i*-th of these lines contains three integers *u*~*i*~, *v*~*i*~ and *c*~*i*~ (1 ≤ *u*~*i*~, *v*~*i*~ ≤ *n*, 1 ≤ *c*~*i*~ ≤ 1000), denoting the crossroads connected by the *i*-th road and its difficulty.
