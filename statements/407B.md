...
The first line contains integer *n* (1 ≤ *n* ≤ 10^3^) — the number of rooms. The second line contains *n* integers *p*~*i*~ (1 ≤ *p*~*i*~ ≤ *i*). Each *p*~*i*~ denotes the number of the room, that someone can reach, if he will use the second portal in the *i*-th room.
