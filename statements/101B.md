...
The first line contains two space-separated integers: *n* and *m* (1 ≤ *n* ≤ 10^9^, 0 ≤ *m* ≤ 10^5^). Then follow *m* lines each containing two integers *s*~*i*~, *t*~*i*~. They are the numbers of starting stops and end stops of the buses (0 ≤ *s*~*i*~ < *t*~*i*~ ≤ *n*).
