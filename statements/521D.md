...
The second line contains *k* space-separated numbers *a*~*i*~ (1 ≤ *a*~*i*~ ≤ 10^6^), the initial values of skills.

Next *n* lines contain 3 space-separated numbers *t*~*j*~, *i*~*j*~, *b*~*j*~ (1 ≤ *t*~*j*~ ≤ 3, 1 ≤ *i*~*j*~ ≤ *k*, 1 ≤ *b*~*j*~ ≤ 10^6^) — the type of the *j*-th improvement (1 for assigning, 2 for adding, 3 for multiplying), the skill to which it can be applied and the value of *b* for this improvement.
