...
The first line contains integer *n* (1 ≤ *n* ≤ 10^5^). The second input line contains *n* space-separated integers *a*~1~, *a*~2~, ..., *a*~*n*~ (0 ≤ *a*~*i*~ ≤ 2·10^9^). It is guaranteed that *a*~1~ ≤ *a*~2~ ≤ ... ≤ *a*~*n*~.
