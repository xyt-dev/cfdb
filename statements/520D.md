...
The following *m* lines contain the coordinates of the cubes *x*~*i*~, *y*~*i*~ ( - 10^9^ ≤ *x*~*i*~ ≤ 10^9^, 0 ≤ *y*~*i*~ ≤ 10^9^) in ascending order of numbers written on them. It is guaranteed that the original figure is stable.
