...
The next *n* lines contains pairs of space-separated integers *M*~*x*~, *M*~*y*~ ( - 10^4^ ≤ *M*~*x*~, *M*~*y*~ ≤ 10^4^), coordinates of Misha's trade points.

The next *m* lines contains pairs of space-separated integers *S*~*x*~, *S*~*y*~ ( - 10^4^ ≤ *S*~*x*~, *S*~*y*~ ≤ 10^4^), coordinates of Sasha's trade points.
