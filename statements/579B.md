...
The *i*-th line (*i* > 1) contains *i* - 1 numbers *a*~*i*1~, *a*~*i*2~, ... , *a*~*i*(*i* - 1)~. Here *a*~*ij*~ (1 ≤ *a*~*ij*~ ≤ 10^6^, all *a*~*ij*~ are distinct) denotes the strength of a team consisting of person *i* and person *j* (people are numbered starting from 1.)
