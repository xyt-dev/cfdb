...
The second line contains *n* integers *a*~1~, ..., *a*~*n*~ (0 ≤ *a*~*i*~ ≤ 10^9^), where *a*~*i*~ is the magic power of the *i*-th shaman.

After that *q* lines follow, the *i*-th of them contains two integers *p*~*i*~ and *x*~*i*~ (1 ≤ *p*~*i*~ ≤ *n*, 0 ≤ *x*~*i*~ ≤ 10^9^) that mean that the new power of the *p*~*i*~-th shaman is *x*~*i*~.
