...
The next *n* lines contain the description of Pokemons in the gyms. The *i*-th of these lines begins with the integer *g*~*i*~ (1 ≤ *g*~*i*~ ≤ 10^5^) — the number of Pokemon in the *i*-th gym. After that *g*~*i*~ integers follow, denoting types of the Pokemons in the *i*-th gym. Each of these integers is between 1 and *m*.

The total number of Pokemons (the sum of all *g*~*i*~) does not exceed 5·10^5^.
