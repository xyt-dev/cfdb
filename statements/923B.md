...
The second line contains *N* integers *V*~1~, *V*~2~, ..., *V*~*N*~ (0 ≤ *V*~*i*~ ≤ 10^9^), where *V*~*i*~ is the initial size of a snow pile made on the day *i*.

The third line contains *N* integers *T*~1~, *T*~2~, ..., *T*~*N*~ (0 ≤ *T*~*i*~ ≤ 10^9^), where *T*~*i*~ is the temperature on the day *i*.
