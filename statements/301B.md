...
The second line contains *n* - 2 integers: *a*~2~, *a*~3~, ..., *a*~*n* - 1~ (1 ≤ *a*~*i*~ ≤ 10^3^). The next *n* lines contain the coordinates of the stations. The *i*-th of them contains two integers *x*~*i*~, *y*~*i*~ (-100 ≤ *x*~*i*~, *y*~*i*~ ≤ 100).
