...
The second line contains *n* integers (1 ≤ *a*~*i*~ ≤ 10^9^) — the distance from the *i*-th stop to the central square. The numbers in the second line go in the increasing order.
