...
- 4 *l* *r* *x* *y*: Print the sum of the *x*-th power of *a*~*i*~ such that *l* ≤ *i* ≤ *r*, modulo *y*, i.e.
...
The only line contains four integers *n*, *m*, *seed*, *v*~*max*~ (1 ≤ *n*, *m* ≤ 10^5^, 0 ≤ *seed* < 10^9^ + 7, 1 ≤ *vmax* ≤ 10^9^).
