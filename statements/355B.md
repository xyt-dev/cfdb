...
- A ticket for one ride on some bus or trolley. It costs *c*~1~ burles;
- A ticket for an unlimited number of rides on some bus or on some trolley. It costs *c*~2~ burles;
- A ticket for an unlimited number of rides on all buses or all trolleys. It costs *c*~3~ burles;
- A ticket for an unlimited number of rides on all buses and trolleys. It costs *c*~4~ burles.
