...
- Let's assume that [(*r*~1~, *c*~1~), ..., (*r*~*m*~, *c*~*m*~)] is a correct path of length *m*, then paths [(*r*~1~, *c*~1~), ..., (*r*~*m*~, *c*~*m*~), (*r*~*m*~ + 1, *c*~*m*~)] and [(*r*~1~, *c*~1~), ..., (*r*~*m*~, *c*~*m*~), (*r*~*m*~, *c*~*m*~ + 1)] are correct paths of length *m* + 1.
