...
The first line contains a single integer *n* — the number of centers (3 ≤ *n* ≤ 3000). The following *n* lines each contain two integers *x*~*i*~, *y*~*i*~ ( - 10^4^ ≤ *x*~*i*~, *y*~*i*~ ≤ 10^4^) — the coordinates of potential circle centers, provided by the Company.
