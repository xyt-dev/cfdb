...
```
InteractorSolution13 3 1 10001 22 33 1R 2 2 0 2 01R 2 2 0 2 12R 2 2 0 2 11AC
```
...
- if $base\_move\_count \lt moves \leq 2 \cdot base\_move\_count$, you get $20 - \frac{10\cdot(moves + 1)}{base\_move\_count + 1}$ points.
