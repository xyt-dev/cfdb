...
This is the easy version of the problem. The difference between the versions is that in this version, the string $s$ contains no character 1. You can hack only if you solved all versions of this problem.
