...
The first line contains three integers *n*, *m* and *k* (1 ≤ *n*, *m* ≤ 10^4^, 1 ≤ *k* ≤ 100). The second line contains three integers *s*~1~, *s*~2~ and *f* (1 ≤ *s*~1~, *s*~2~, *f* ≤ *n*).

The next *m* lines contains the descriptions of the roads that cannot be changed by Levko. Each line contains three integers *a*~*i*~, *b*~*i*~ and *c*~*i*~ (1 ≤ *a*~*i*~, *b*~*i*~ ≤ *n*, 1 ≤ *c*~*i*~ ≤ 10^9^), representing a road from intersection *a*~*i*~ to intersection *b*~*i*~ of length *c*~*i*~.

The next *k* lines contains the descriptions of the roads that can be changed by Levko. Each line contains four integers *a*~*i*~, *b*~*i*~, *l*~*i*~ and *r*~*i*~ (1 ≤ *a*~*i*~, *b*~*i*~ ≤ *n*, 1 ≤ *l*~*i*~ ≤ *r*~*i*~ ≤ 10^9^), representing a road from intersection *a*~*i*~ to intersection *b*~*i*~, Levko can set the road's length within limits [*l*~*i*~, *r*~*i*~].
