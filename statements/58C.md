...
The first line contains integer *n* (1 ≤ *n* ≤ 10^5^) which is the number of trees. The second line contains integers *a*~*i*~ (1 ≤ *a*~*i*~ ≤ 10^5^) which are the heights of the trees.
