...
Each of the next *n* lines contains two non-negative space-separated integers — *a*~*i*~ and *b*~*i*~ (0 ≤ *a*~*i*~, *b*~*i*~ ≤ 10^4^) — the numbers, written at the top and the bottom of the *i*-th card correspondingly.
