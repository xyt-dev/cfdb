...
The first line contains a positive integer *n* (2 ≤ *n* ≤ 30000), *n* is the length of the given sequence. The second line contains elements of the given sequence *a*~1~, *a*~2~, ..., *a*~*n*~ ( - 10^8^ ≤ *a*~*i*~ ≤ 10^8^). The elements of the progression are different integers.
