...
Next line contains the only integer *n* (1 ≤ *n* ≤ 1000) — the number of moments of time you have to solve the problem for. Each of the next *n* lines contains a single integer *t*~*i*~ (0 ≤ *t*~*i*~ ≤ 10^12^).
