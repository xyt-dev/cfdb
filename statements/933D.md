...
He drew *n* concentric circles on it and numbered these circles from 1 to *n* such that the center of each circle is the same lattice point and the radius of the *k*-th circle is

![](images/933D_2.png)

 times the length of a lattice edge.
