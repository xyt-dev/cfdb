...
- Permutation *p* of numbers from 1 to *N* such that *p*~*i*~ ≠ *i* and *p*~*i*~ & *i* = 0 for all *i* = 1, 2, ..., *N*.
- Permutation *q* of numbers from 1 to *N* such that *q*~*i*~ ≠ *i* and *q*~*i*~ & *i* ≠ 0 for all *i* = 1, 2, ..., *N*.
