...
The first line contains three space-separated integers *n*, *a*, *b* (1 ≤ *n* ≤ 10^5^; 1 ≤ *a*, *b* ≤ 10^9^). The next line contains *n* space-separated distinct integers *p*~1~, *p*~2~, ..., *p*~*n*~ (1 ≤ *p*~*i*~ ≤ 10^9^).
