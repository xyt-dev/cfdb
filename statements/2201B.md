...
- $[\color{red}{2},\color{red}{1},2,1]$: The two cards have different numbers, so they are flipped back into position.
- $[\color{red}{2},\color{blue}{1},\color{red}{2},1]$: The two cards have the same number, so they get discarded.
- $[\color{red}{1},\color{red}{1}]$: The two cards have the same number, so they get discarded.
...
- $[\color{red}{1},\color{red}{2},3,1,2,3]$: The two cards have different numbers, so they are flipped back into position.
- $[\color{blue}{1},\color{blue}{2},\color{red}{3},\color{red}{1},2,3]$: The two cards have different numbers, so they are flipped back into position.
- $[\color{red}{1},\color{blue}{2},\color{blue}{3},\color{red}{1},2,3]$: The two cards have the same number, so they get discarded.
- $[\color{red}{2},\color{blue}{3},\color{red}{2},3]$: The two cards have the same number, so they get discarded.
- $[\color{red}{3},\color{red}{3}]$: The two cards have the same number, so they get discarded.
