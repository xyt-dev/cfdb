...
There are $n$ weighted points on the $OX$-axis. The coordinate and the weight of the $i$-th point is $x_i$ and $w_i$, respectively. All points have distinct coordinates and positive weights. Also, $x_i \lt x_{i + 1}$ holds for any $1 \leq i \lt n$.
...
Then, $q$ lines follows, the $i$-th of them contains two integers $l_i$ and $r_i$ $(1 \leq l_i \lt r_i \leq n)$ — the given subarray of the $i$-th query.
