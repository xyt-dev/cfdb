...
The next *m* lines each describe another mouse. The *i*-th line contains first integer *val*~*i*~ (1 ≤ *val*~*i*~ ≤ 10^9^)  — the cost of the *i*-th mouse, then the type of port (USB or PS/2) that is required to plug the mouse in.
