...
The first line contains integer *n* (1 ≤ *n* ≤ 10^5^). The second line contains *n* integers *a*~1~, *a*~2~, ..., *a*~*n*~ (1 ≤ *a*~*i*~ ≤ 10^9^). The third line contains *n* integers *b*~1~, *b*~2~, ..., *b*~*n*~ (1 ≤ *b*~*i*~ ≤ 10^9^). The numbers in the lines are separated by spaces.
