...
The first line contains one integer number *t* (1 ≤ *t* ≤ 10000) — the number of test sets. Each of the following *t* lines describes one test set. Each line contains integer numbers *n*, *m*, *x*~1~, *y*~1~, *x*~2~, *y*~2~, separated by a space (2 ≤ *n*, *m* ≤ 10^9^, 1 ≤ *x*~1~, *x*~2~ ≤ *n*, 1 ≤ *y*~1~, *y*~2~ ≤ *m*). Cells (*x*~1~, *y*~1~) and (*x*~2~, *y*~2~) are distinct.
