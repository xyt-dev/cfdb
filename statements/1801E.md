...
In each of the following lines, two integers are given $l_i$ and $r_i$ ($1 \le l_i \le r_i \lt 10^9+7$), specifying the acceptable range of prices at the gas station number $i$.
