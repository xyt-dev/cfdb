...
The first line contains two integers *n* and *k* (1 ≤ *n*, *k* ≤ 10^5^). Each of the following *n* lines contain a segment as a pair of integers *l*~*i*~ and *r*~*i*~ ( - 10^5^ ≤ *l*~*i*~ ≤ *r*~*i*~ ≤ 10^5^), separated by a space.
