...
- Assume that $m \gt 1$ players are still in the game, where $m$ is a power of $2$.
...
We are left with players $1$ and $3$. Since $1$ has greater strength ($60 \gt 59$) they win and are declared the absolute winner as they are the last remaining player.
