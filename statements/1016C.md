...
The second line contains *n* numbers *a*~1~, *a*~2~, ..., *a*~*n*~ (1 ≤ *a*~*i*~ ≤ 10^6^) — the growth rate of mushrooms in the first row of the glade.

The third line contains *n* numbers *b*~1~, *b*~2~, ..., *b*~*n*~ (1 ≤ *b*~*i*~ ≤ 10^6^) is the growth rate of mushrooms in the second row of the glade.
