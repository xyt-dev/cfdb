...
The second line contains the sequence of integers *a*~1~, *a*~2~, ..., *a*~*n*~ (1 ≤ *a*~*i*~ ≤ 10^9^), where *a*~*i*~ is equal to the number of milliliters of ink which the pen number *i* currently has.
