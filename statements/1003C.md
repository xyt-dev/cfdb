...
Your answer will be considered correct if the following condition holds: $|res - res_0| \lt 10^{-6}$, where $res$ is your answer, and $res_0$ is the answer given by the jury's solution.
