...
To prepare for the exam, one has to study proofs of *n* theorems. It is known that there will be *k* examination cards on the exam and each card contains

![](images/119B_1.png)

 distinct theorems. Besides, no theorem is mentioned in more than one card (that is,

![](images/119B_2.png)

 theorems won't be mentioned in any card). During the exam several students may get the same card.
...
The first line contains two integers *n* and *k* (1 ≤ *k* ≤ *n* ≤ 100) — the number of theorems and the number of cards correspondingly. The second line contains *n* integers *a*~*i*~ (0 ≤ *a*~*i*~ ≤ 100), the *i*-th number (1 ≤ *i* ≤ *n*) corresponds to Vasya's proficiency in the *i*-th theorem.

The third line contains number *q* (0 ≤ *q* ≤ 100) — the number of people that have taken the exam before Vasya. Each of the following *q* lines contains the description of a student's card:
