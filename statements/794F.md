...
The following line contains *n* integers *a*~1~, *a*~2~, ..., *a*~*n*~ (1 ≤ *a*~*i*~ < 10^9^) denoting the amount of money in each cell initially. These integers do not contain leading zeros.
