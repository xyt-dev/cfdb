...
The second line contains *k* space-separated integers: *a*~1~, ..., *a*~*k*~ (1 ≤ *a*~*i*~ ≤ *p*) — the marks that Vova got for the tests he has already written.
...
The median of sequence *a*~1~, ..., *a*~*n*~ where *n* is odd (in this problem *n* is always odd) is the element staying on (*n* + 1) / 2 position in the sorted list of *a*~*i*~.
