...
- $b$ is non-decreasing, which means that for every $1 \lt i\leq n$, $b_i\geq b_{i-1}$ must hold
- $c$ is non-increasing, which means that for every $1 \lt i\leq n$, $c_i\leq c_{i-1}$ must hold
