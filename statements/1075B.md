...
The second line contains $n + m$ integers $x_1, x_2, \ldots, x_{n+m}$ ($1 \le x_1 \lt x_2 \lt \ldots \lt x_{n+m} \le 10^9$), where $x_i$ is the coordinate where the $i$-th resident lives.
