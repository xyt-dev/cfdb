...
In the first sample if Peter chooses a number 011~2~, then *a* = 101~2~, *b* = 011~2~, *c* = 000~2~, the sum of their values is 8. If he chooses the number 100~2~, then *a* = 101~2~, *b* = 011~2~, *c* = 111~2~, the sum of their values is 15.
