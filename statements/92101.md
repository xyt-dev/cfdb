...
- move-DIR – move to the adjacent cell in the

![](images/92101_1.png)

 direction. *down* increases the number of the row by 1, *right* increases the number of the column by 1. In case there’s a wall or a closed door in this direction, nothing’s happening.
...
The robot will fulfill your commands sequentially until it exits the labyrinth, or it runs out of the commands, or the *terminate* command is run, or the quantity of the fulfilled commands exceeds the bound number 5·10^6^.
...
- *W*~*i*~ – labyrinth’s weight, some fixed constant.
...
- [https://drive.google.com/file/d/1dkIBfW_Gy6c3FJtXjMXZPMsGKRyn3pzp](<https://drive.google.com/file/d/1dkIBfW_Gy6c3FJtXjMXZPMsGKRyn3pzp>)
- [https://www.dropbox.com/s/77jrplnjgmviiwt/aimmaze.zip?dl=0](<https://www.dropbox.com/s/77jrplnjgmviiwt/aimmaze.zip?dl=0>)
- [https://yadi.sk/d/JNXDLeH63RzaCi](<https://yadi.sk/d/JNXDLeH63RzaCi>)
