...
Each of the next *n* lines contains two integers *x*~*i*~, *t*~*i*~ (0 ≤ *x*~*i*~, *t*~*i*~ ≤ 10^9^) — the position and the initial length of the tongue of the *i*-th frog. It is guaranteed that all *x*~*i*~ are different.

Next *m* lines contain two integers each *p*~*j*~, *b*~*j*~ (0 ≤ *p*~*j*~, *b*~*j*~ ≤ 10^9^) — the position and the size of the *j*-th mosquito.
