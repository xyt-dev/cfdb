...
The first line contains an integer *n* (1 ≤ *n* ≤ 400) — the amount of the coins' face values. The second line contains *n* integers *a*~*i*~ (1 ≤ *a*~*i*~ ≤ 10^9^), describing the face values. It is guaranteed that *a*~1~ > *a*~2~ > ... > *a*~*n*~ and *a*~*n*~ = 1.
