...
The first line of input contains two integers $n$ and $k$ $(1\leq n\leq 2^{20}, 0\leq k \lt n)$.

The second line of input contains $n$ integers $B_1,B_2,\ldots,B_n$ $(1\leq B_i \lt 2^{20})$.
