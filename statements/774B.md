...
Each of the following *n* lines contains two integers *c*~*i*~ and *w*~*i*~ (1 ≤ *c*~*i*~, *w*~*i*~ ≤ 10^9^) — significance and width of the *i*-th cup for Physics olympiads.

Each of the following *m* lines contains two integers *c*~*j*~ and *w*~*j*~ (1 ≤ *c*~*j*~, *w*~*j*~ ≤ 10^9^) — significance and width of the *j*-th cup for Informatics olympiads.
