...
Given an integer $n$, find the smallest integer $x \ge n$ such that $\text{$gcdSum$}(x) \gt 1$.
...
So the smallest number $\ge 11$ whose $gcdSum$ $ \gt 1$ is $12$.
...
So the smallest number $\ge 31$ whose $gcdSum$ $ \gt 1$ is $33$.
