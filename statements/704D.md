...
The next *n* lines contain the shields coordinates. The *i*-th of these lines contains two integers *x*~*i*~ and *y*~*i*~ (1 ≤ *x*~*i*~, *y*~*i*~ ≤ 10^9^).

The next *m* lines contain the constrains. The *j*-th of these lines contains three integers *t*~*j*~, *l*~*j*~ and *d*~*j*~ (1 ≤ *t*~*j*~ ≤ 2, 1 ≤ *l*~*j*~ ≤ 10^9^, 0 ≤ *d*~*j*~ ≤ *n*).
