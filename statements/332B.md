...
The first line contains two integers *n* and *k* (2 ≤ *n* ≤ 2·10^5^, 0 < 2*k* ≤ *n*) — the number of laws accepted by the parliament and the length of one segment in the law list, correspondingly. The next line contains *n* integers *x*~1~, *x*~2~, ..., *x*~*n*~ — the absurdity of each law (1 ≤ *x*~*i*~ ≤ 10^9^).
