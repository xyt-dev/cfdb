...
- In the second line print *n* integers *x*~1~, *x*~2~, ..., *x*~*n*~ — the coordinates of the vertical lines.
- In the third line in the same format print *m* integers *y*~1~, *y*~2~, ..., *y*~*m*~ — the coordinates of the horizontal lines.
