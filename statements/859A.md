...
The first line of input contains *K* (1 ≤ *K* ≤ 25), the number of onsite finalists you know. The second line of input contains *r*~1~, *r*~2~, ..., *r*~*K*~ (1 ≤ *r*~*i*~ ≤ 10^6^), the qualifying ranks of the finalists you know. All these ranks are distinct.
