...
- No two neighbouring letters of a string coincide; that is, if we represent a string as *s* = *s*~1~*s*~2~... *s*~*n*~, then the following inequality holds, *s*~*i*~ ≠ *s*~*i* + 1~(1 ≤ *i* < *n*).
