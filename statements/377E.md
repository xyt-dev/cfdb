...
Each of the next *n* lines contains two integers *v*~*i*~ and *c*~*i*~ (1 ≤ *v*~*i*~ ≤ 10^8^, 0 ≤ *c*~*i*~ ≤ 10^8^) — the number of cookies the *i*-th building brings per second and the building's price.
