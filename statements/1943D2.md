...
The first line of each test case contains three positive integers $n$, $k$ and $p$ ($3 \leq n \leq 3000$, $1 \leq k \leq n$, $10^8 \lt p \lt 10^9$) — the length of the array $a$, the upper bound on the elements of $a$ and modulus $p$.
