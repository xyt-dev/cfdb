...
Each of the next *n* lines contains one string *a*~*i*~ (1 ≤ |*a*~*i*~| ≤ 50) consisting of only lowercase English letters. The sum of string lengths will not exceed 5·10^4^.
