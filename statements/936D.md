...
The first line contains four integers *n*, *m*~1~, *m*~2~ and *t*, the length of the field, the number of obstacles in the first lane, the number of obstacles in the second lane and the number of tank steps before reloading, respectively (1 ≤ *n* ≤ 10^9^; 0 ≤ *m*~1~, *m*~2~ ≤ *n*; 0 ≤ *m*~1~ + *m*~2~ ≤ 10^6^; 1 ≤ *t* ≤ *n*).
