...
- up key: the new cursor position (*nr*, *nc*) = (*max*(*r* - 1, 1), *min*(*a*~*nr*~, *c*))
- down key: the new cursor position (*nr*, *nc*) = (*min*(*r* + 1, *n*), *min*(*a*~*nr*~, *c*))
- left key: the new cursor position (*nr*, *nc*) = (*r*, *max*(0, *c* - 1))
- right key: the new cursor position (*nr*, *nc*) = (*r*, *min*(*a*~*nr*~, *c* + 1))
- HOME key: the new cursor position (*nr*, *nc*) = (*r*, 0)
- END key: the new cursor position (*nr*, *nc*) = (*r*, *a*~*r*~)
...
The second line contains *n* integers *a*~1~, *a*~2~, ..., *a*~*n*~(1 ≤ *a*~*i*~ ≤ 10^8^).
