...
An inversion in sequence $d$ is a pair of indices $(i, j)$ such that $i \lt j$ and $d_i \gt d_j$. For example, the array $d = [5, 3, 7, 5]$ has exactly two inversions — $(1, 2)$ and $(3, 4)$, since $d_1 = 5 \gt 3 = d_2$ and $d_3 = 7 \gt 5 = d_4$.
