...
The second line contains *n* integers *t*~1~, *t*~2~, ..., *t*~*n*~ (1 ≤ *t*~*i*~ ≤ 10^12^) where *t*~*i*~ denotes the number of people subscribing the *i*-th fanpage.
