...
The second line contains *n* space-separated integers, *w*~1~, *w*~2~, ..., *w*~*n*~ (1 ≤ *w*~*i*~ ≤ 10^6^) — strengths of warriors.

The third line contains *n* space-separated integers, *h*~1~, *h*~2~, ..., *h*~*n*~ (1 ≤ *h*~*i*~ ≤ 10^6^) — strengths of horses.
