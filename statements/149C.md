...
The first line contains the only integer *n* (2 ≤ *n* ≤ 10^5^) which represents the number of guys in the yard. The next line contains *n* positive space-separated integers, *a*~*i*~ (1 ≤ *a*~*i*~ ≤ 10^4^), the *i*-th number represents the *i*-th boy's playing skills.
