...
The second line contains integer sequence *t*~1~, *t*~2~, ..., *t*~*m*~ (1 ≤ *t*~*i*~ ≤ 10^18^) — moments of time when clients will come. The values *t*~*i*~ are given in non-decreasing order.
