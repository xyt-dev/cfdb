...
*n* lines follow, the *i*-th of these lines contain single integer *s*~*i*~ (0 ≤ *s*~*i*~ ≤ 3·10^5^) and then *s*~*i*~ distinct integers, each between 1 and *m* — the types of ice cream in the *i*-th vertex. The sum of *s*~*i*~ doesn't exceed 5·10^5^.
