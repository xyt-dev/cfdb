...
The second line contains four integers $x_1$, $y_1$, $x_2$ and $y_2$ ($0 \le x_1 \lt x_2 \le W$; $0 \le y_1 \lt y_2 \le H$) — the coordinates of the corners of the first table.
