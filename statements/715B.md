...
Then, *m* lines describing the edges of the graph follow. *i*-th of them contains three integers, *u*~*i*~, *v*~*i*~, *w*~*i*~ (0 ≤ *u*~*i*~, *v*~*i*~ ≤ *n* - 1,  *u*~*i*~ ≠ *v*~*i*~,  0 ≤ *w*~*i*~ ≤ 10^9^). *u*~*i*~ and *v*~*i*~ denote the endpoints of the edge and *w*~*i*~ denotes its weight. If *w*~*i*~ is equal to 0 then the weight of the corresponding edge was erased.
