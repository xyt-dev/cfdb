...
The second line contains *n* positive integers *a*~1~, *a*~2~, ..., *a*~*n*~ (1 ≤ *a*~*i*~ ≤ 10^9^), where *a*~*i*~ is the index of a language, which the *i*-th scientist knows.

The third line contains a positive integer *m* (1 ≤ *m* ≤ 200 000) — the number of movies in the cinema.

The fourth line contains *m* positive integers *b*~1~, *b*~2~, ..., *b*~*m*~ (1 ≤ *b*~*j*~ ≤ 10^9^), where *b*~*j*~ is the index of the audio language of the *j*-th movie.

The fifth line contains *m* positive integers *c*~1~, *c*~2~, ..., *c*~*m*~ (1 ≤ *c*~*j*~ ≤ 10^9^), where *c*~*j*~ is the index of subtitles language of the *j*-th movie.
