...
- All of cities in the country are beautiful, but each is beautiful in its own way. Beauty value of *i*-th city equals to *c*~*i*~.
...
- Price of passing a road directly depends on beauty values of cities it connects. Thus if there is a road between cities *i* and *j*, price of passing it equals *c*~*i*~·*c*~*j*~.
