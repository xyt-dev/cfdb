...
The first line of the input contains integer *n* (1 ≤ *n* ≤ 10^5^) — the number of notes in the song. The second line contains *n* integers *a*~*i*~ (1 ≤ *a*~*i*~ ≤ 10^6^). The third line contains *n* integers *b*~*i*~ (1 ≤ *b*~*i*~ ≤ 10^6^).
