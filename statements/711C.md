...
Then *n* lines follow. Each of them contains *m* integers. The *j*-th number on the *i*-th of them line denotes *p*~*i*, *j*~ (1 ≤ *p*~*i*, *j*~ ≤ 10^9^) — the amount of litres the friends need to color *i*-th tree with color *j*. *p*~*i*, *j*~'s are specified even for the initially colored trees, but such trees still can't be colored.
