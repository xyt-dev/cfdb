...
The input consists of eight lines, the *i*-th line contains two space-separated integers *x*~*i*~ and *y*~*i*~ (0 ≤ *x*~*i*~, *y*~*i*~ ≤ 10^6^). You do not have any other conditions for these points.
