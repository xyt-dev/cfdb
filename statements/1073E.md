...
The only line of the input contains three integers $l$, $r$ and $k$ ($1 \le l \le r \lt 10^{18}, 1 \le k \le 10$) — the borders of the segment and the maximum number of different digits.
