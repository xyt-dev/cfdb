...
The second line contains *n* integers *t*~1~, *t*~2~, ..., *t*~*n*~ (1 ≤ *t*~*i*~ ≤ 10^9^) where *t*~*i*~ describes how good is Limak's relation with the *i*-th friend.
...
- "1 2" — Friend 2 becomes online. There are 3 friends online now but we were given *k* = 2 so only two friends can be displayed. Limak has worse relation with friend 1 than with other two online friends (*t*~1~ < *t*~2~, *t*~3~) so friend 1 won't be displayed
- "2 1" — Print "NO".
- "2 2" — Print "YES".
- "2 3" — Print "YES".
