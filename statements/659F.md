...
Then *n* lines follow, each containing *m* positive integers *a*~*i*, *j*~ (1 ≤ *a*~*i*, *j*~ ≤ 10^9^), where *a*~*i*, *j*~ is equal to the number of cubic meters of hay making the hay stack on the *i*-th row and *j*-th column of the table.
