...
The second line of the input contains $3n$ numbers $x_1, x_2,\ldots, x_{3n}$ ($1 \le x_1 \lt x_2 \lt \ldots \lt x_{3n} \le 6n$) – the cards in Federico's pocket at the end of the game.
...
The $i$-th line should contain, in increasing order, the integers $a_i \lt b_i \lt c_i$ written on the three cards taken by the player during the $i$-th turn (so taken by Federico if $i$ is odd and by Giada if $i$ is even).
