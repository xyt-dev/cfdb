...
From the other side, users don't like ads. So it was decided to show no more than

![](images/643G_1.png)

 ads at once. You are asked to develop a system to sell segments of slots and choose ads in accordance with the rules described above.
...
For each query of the second type answer should be printed in a separate line. First integer of the answer should be the number of advertisements that will be shown

![](images/643G_2.png)

. Next *cnt* integers should be advertisers' ids.

It is allowed to print one advertiser more than once, but each advertiser that owns at least

![](images/643G_3.png)

 slots of the segment from *l* to *r* should be in your answer.
