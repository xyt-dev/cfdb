...
The first line contains integer *n* (1 ≤ *n* ≤ 100) — the number of spotlights. Each of the *n* lines contains two space-separated integers, *a*~*i*~ and *l*~*i*~ (0 ≤ *a*~*i*~ ≤ 10^8^, 1 ≤ *l*~*i*~ ≤ 10^8^). Number *a*~*i*~ shows how much further the *i*-th spotlight to the north, and number *l*~*i*~ shows the length of the segment it illuminates.
