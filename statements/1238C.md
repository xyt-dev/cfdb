...
The second line contains $n$ integers $p_1, p_2, \dots, p_n$ ($h = p_1 \gt p_2 \gt \dots \gt p_n \ge 1$) — the corresponding moved out platforms in the descending order of their heights.
