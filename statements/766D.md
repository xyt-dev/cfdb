...
Then *m* lines follow, each of them contains an integer *t* (1 ≤ *t* ≤ 2) followed by two different words *x*~*i*~ and *y*~*i*~ which has appeared in the dictionary words. If *t* = 1, that means *x*~*i*~ has a synonymy relation with *y*~*i*~, otherwise *x*~*i*~ has an antonymy relation with *y*~*i*~.
