...
You are given two integers $l$ and $r$, where $l \lt r$. We will add $1$ to $l$ until the result is equal to $r$. Thus, there will be exactly $r-l$ additions performed. For each such addition, let's look at the number of digits that will be changed after it.
...
Each test case is characterized by two integers $l$ and $r$ ($1 \le l \lt r \le 10^9$).
