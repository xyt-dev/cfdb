...
If $x^y \lt y^x$, then print '<' (without quotes). If $x^y \gt y^x$, then print '>' (without quotes). If $x^y = y^x$, then print '=' (without quotes).
...
In the second example $10^3 = 1000 \lt 3^{10} = 59049$.
