...
Next *n* lines contain three integers each *v*~*i*~, *d*~*i*~, *p*~*i*~ (1 ≤ *v*~*i*~, *d*~*i*~, *p*~*i*~ ≤ 10^6^) — the volume of the cry in the doctor's office, the volume of the cry in the hall and the confidence of the *i*-th child.
