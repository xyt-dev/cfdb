...
- Let $s_1,s_2,\ldots,s_k$ be the indices of $a$ that are not good in increasing order. That is, $s_j \lt s_{j+1}$ and if index $i$ is not good, then there exists $j$ such that $s_j=i$.
