...
The next *n* lines contain three integers each: *l*~*i*~, *r*~*i*~, *c*~*i*~ (0 ≤ *l*~*i*~ < *r*~*i*~ ≤ 10^9^, 0 ≤ *c*~*i*~ ≤ 10^9^), describing one caramel cloud.

The next line contains single integer *m* (1 ≤ *m* ≤ 3·10^5^) – the number of seedlings. Each of the seedlings is described with one integer *k*~*j*~ (1 ≤ *k*~*j*~ ≤ 10^9^) – the required number of sunny minutes.
