...
Formally, let the string $s$ have the form $s=s_1s_2 \dots s_n$ ($n \gt 1$). During one operation, you choose an arbitrary index $i$ ($1 \le i \lt n$) and replace $s=s_1s_2 \dots s_{i-1}s_{i+2} \dots s_n$.
