...
The first line contains three integers *n*, *l* and *w* (1 ≤ *n* ≤ 10^5^, 1 ≤ *l* ≤ *n*, 0 ≤ *w* ≤ 10^9^). The next *n* - 1 lines contain the descriptions of the tree edges. The *i*-th line contains two integers *p*~*i*~, *w*~*i*~ (1 ≤ *p*~*i*~ < (*i* + 1), 0 ≤ *w*~*i*~ ≤ 10^4^), that mean that the *i*-th edge connects vertex (*i* + 1) and *p*~*i*~ and has weight *w*~*i*~.
