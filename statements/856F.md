...
The following *n* lines contain two integers each: *a*~*i*~, *b*~*i*~ — intervals when Vasya can play (0 ≤ *a*~*i*~ < *b*~*i*~ ≤ 10^18^, *b*~*i*~ < *a*~*i* + 1~).

The following *m* lines contain two integers each: *c*~*i*~, *d*~*i*~ — intervals when Petya can play (0 ≤ *c*~*i*~ < *d*~*i*~ ≤ 10^18^, *d*~*i*~ < *c*~*i* + 1~).
