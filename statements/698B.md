...
- There must be exactly one index *r* that *p*~*r*~ = *r*. A vertex *r* is a root of the tree.
- For all other *n* - 1 vertices *i*, there is an edge between vertex *i* and vertex *p*~*i*~.
