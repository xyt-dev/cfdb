...
The first line contains a single integer *n* (1 ≤ *n* ≤ 50) — the number of chocolate bar wrappings that brought points to Vasya. The second line contains space-separated integers *p*~1~, *p*~2~, ..., *p*~*n*~ (1 ≤ *p*~*i*~ ≤ 10^9^). The third line contains 5 integers *a*, *b*, *c*, *d*, *e* (1 ≤ *a* < *b* < *c* < *d* < *e* ≤ 10^9^) — the prizes' costs.
