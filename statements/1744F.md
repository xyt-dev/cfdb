...
You are given a permutation $p_1, p_2, \ldots, p_n$ of length $n$ of numbers $0, \ldots, n - 1$. Count the number of subsegments $1 \leq l \leq r \leq n$ of this permutation such that $mex(p_l, p_{l+1}, \ldots, p_r) \gt med(p_l, p_{l+1}, \ldots, p_r)$.
...
For each test case print the answer in a single line: the number of subsegments $1 \leq l \leq r \leq n$ of this permutation such that $mex(p_l, p_{l+1}, \ldots, p_r) \gt med(p_l, p_{l+1}, \ldots, p_r)$.
...
The first test case contains exactly one subsegment and $mex({0}) = 1 \gt med({0}) = 0$ on it.
