...
Second line contains *n* space-separated integers *a*~*i*~ (1 ≤ *a*~*i*~ ≤ 10^9^) — height of each model. Pay attention that height of fashion designer is not given and can be less than 1.
