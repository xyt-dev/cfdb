...
In each of the next *n* - 1 lines three space-separated integers *a*~*i*~, *b*~*i*~, *c*~*i*~ (1 ≤ *a*~*i*~, *b*~*i*~ ≤ *n*, 1 ≤ *c*~*i*~ ≤ 10^9^) are given indicating an edge between *a*~*i*~ and *b*~*i*~ with weight equal to *c*~*i*~.
