...
The first line contains integer *m* (1 ≤ *m* ≤ 10^5^). The next line contains *m* integers *b*~1~, *b*~2~, ..., *b*~*m*~ (1 ≤ *b*~*i*~ ≤ 10^5^).

The third line contains integer *q* (1 ≤ *q* ≤ 10^5^) — the number of questions. The next *q* lines contain pairs of integers, *i*-th of them contains a pair of integers *l*~*i*~, *r*~*i*~ (1 ≤ *l*~*i*~ ≤ *r*~*i*~ ≤ *m*) — the description of *i*-th question.
