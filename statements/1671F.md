...
Calculate the number of permutations $p$ of size $n$ with exactly $k$ inversions (pairs of indices $(i, j)$ such that $i \lt j$ and $p_i \gt p_j$) and exactly $x$ indices $i$ such that $p_i \gt p_{i+1}$.
