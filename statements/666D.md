...
*t* descriptions of plates follow. A description of each plate consists of four lines. Each line consists of a pair of integers numbers *x*~*i*~, *y*~*i*~ ( - 10^8^ ≤ *x*~*i*~, *y*~*i*~ ≤ 10^8^) — coordinates of the next bot. All bots are in different locations.
