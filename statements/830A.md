...
The second line contains *n* distinct integers *a*~1~, *a*~2~, ..., *a*~*n*~ (1 ≤ *a*~*i*~ ≤ 10^9^) — positions in which people are located initially. The positions are given in arbitrary order.

The third line contains *k* distinct integers *b*~1~, *b*~2~, ..., *b*~*k*~ (1 ≤ *b*~*j*~ ≤ 10^9^) — positions of the keys. The positions are given in arbitrary order.
