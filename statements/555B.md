...
Next *n* lines each contain two integers *l*~*i*~ and *r*~*i*~ (1 ≤ *l*~*i*~ ≤ *r*~*i*~ ≤ 10^18^) — the coordinates of the island endpoints.

The last line contains *m* integer numbers *a*~1~, *a*~2~, ..., *a*~*m*~ (1 ≤ *a*~*i*~ ≤ 10^18^) — the lengths of the bridges that Andrewid got.
