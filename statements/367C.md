...
The first line contains two integers *n* and *m* (1 ≤ *n* ≤ 2·10^6^, 1 ≤ *m* ≤ 10^5^). Next *m* lines contain pairs of integers. The *i*-th line contains numbers *q*~*i*~, *w*~*i*~ (1 ≤ *q*~*i*~, *w*~*i*~ ≤ 10^5^).
