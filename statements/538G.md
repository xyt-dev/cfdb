...
Next *n* lines contain three space-separated integers — *t*~*i*~, *x*~*i*~, *y*~*i*~ (1 ≤ *t*~*i*~ ≤ 10^18^,  - 10^18^ ≤ *x*~*i*~, *y*~*i*~ ≤ 10^18^). The radar data is given chronologically, i.e. *t*~*i*~ < *t*~*i* + 1~ for all *i* from 1 to *n* - 1.
