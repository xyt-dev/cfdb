...
You are given a set of *n* elements indexed from 1 to *n*. The weight of *i*-th element is *w*~*i*~. The weight of some subset of a given set is denoted as
...
The second line contains *n* integers *w*~*i*~ (1 ≤ *w*~*i*~ ≤ 10^9^)— weights of elements of the set.
...
- {{1, 2, 3}, {4}}, *W*(*R*) = 3·(*w*~1~ + *w*~2~ + *w*~3~) + 1·*w*~4~ = 24;
- {{1, 2, 4}, {3}}, *W*(*R*) = 26;
- {{1, 3, 4}, {2}}, *W*(*R*) = 24;
- {{1, 2}, {3, 4}}, *W*(*R*) = 2·(*w*~1~ + *w*~2~) + 2·(*w*~3~ + *w*~4~) = 20;
- {{1, 3}, {2, 4}}, *W*(*R*) = 20;
- {{1, 4}, {2, 3}}, *W*(*R*) = 20;
- {{1}, {2, 3, 4}}, *W*(*R*) = 26;
