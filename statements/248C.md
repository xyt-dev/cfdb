...
- *y*~1~, *y*~2~ — the *y*-coordinates of the side pillars of the goalposts of robo-Wallace's opponents;
- *y*~*w*~ — the *y*-coordinate of the wall to which Robo-Wallace is aiming;
- *x*~*b*~, *y*~*b*~ — the coordinates of the ball's position when it is hit;
...
The first and the single line contains integers *y*~1~, *y*~2~, *y*~*w*~, *x*~*b*~, *y*~*b*~, *r* (1 ≤ *y*~1~, *y*~2~, *y*~*w*~, *x*~*b*~, *y*~*b*~ ≤ 10^6^; *y*~1~ < *y*~2~ < *y*~*w*~; *y*~*b*~ + *r* < *y*~*w*~; 2·*r* < *y*~2~ - *y*~1~).
...
If Robo-Wallace can't score a goal in the described manner, print "-1" (without the quotes). Otherwise, print a single number *x*~*w*~ — the abscissa of his point of aiming.
...
Note that in the first and third samples other correct values of abscissa *x*~*w*~ are also possible.
