...
The first line contains a positive integer *n* (1 ≤ *n* ≤ 100) — the number of records in the system log. Next follow *n* events from the system journal in the order in which the were made. Each event was written on a single line and looks as "+ *r*~*i*~" or "- *r*~*i*~", where *r*~*i*~ is an integer from 1 to 10^6^, the registration number of the visitor (that is, distinct visitors always have distinct registration numbers).
