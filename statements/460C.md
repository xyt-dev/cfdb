...
The first line contains space-separated integers *n*, *m* and *w* (1 ≤ *w* ≤ *n* ≤ 10^5^; 1 ≤ *m* ≤ 10^5^). The second line contains space-separated integers *a*~1~, *a*~2~, ..., *a*~*n*~ (1 ≤ *a*~*i*~ ≤ 10^9^).
