...
Assume that the expected cost of the trips is written as an irreducible fraction *a* / *b* (that is, *a* and *b* are coprime). Then Heidi, the weird cow that she is, asks you to output

![](images/802J3_1.png)

. (Output a single integer between 0 and 10^9^ + 6.)
