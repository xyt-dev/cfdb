...
Then $n$ lines follow, the $i$-th line contains two integers $l_i$ and $r_i$ ($1 \le l_i \lt r_i \le 10^6$) — the endpoints of the $i$-th initial segment.

Then $m$ lines follow, the $i$-th line contains two integers $L_i$ and $R_i$ ($1 \le L_i \lt R_i \le 10^6$) — the endpoints of the $i$-th terminal segment.
