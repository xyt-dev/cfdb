...
. Next *m* lines contain the descriptions of the streets in the following format: *x*~*i*~ *y*~*i*~ *k*~*i*~ *v*~1~ *v*~2~ ... *v*~*k*~, where *x*~*i*~ and *y*~*i*~ (1 ≤ *x*~*i*~, *y*~*i*~ ≤ *n*, *x*~*i*~ ≠ *y*~*i*~) are numbers of shops connected by a street, *k*~*i*~ (0 ≤ *k*~*i*~ ≤ *n*) is the number of visions on the way from *x*~*i*~ to *y*~*i*~; *v*~1~, *v*~2~, ..., *v*~*k*~ (1 ≤ *v*~*i*~ ≤ *n*) describe the visions: the numbers of the shops Neo saw. Note that the order of the visions matters.
