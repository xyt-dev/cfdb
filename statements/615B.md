...
Then follow *m* lines, each containing two integers *u*~*i*~ and *v*~*i*~ (1 ≤ *u*~*i*~, *v*~*i*~ ≤ *n*, *u*~*i*~ ≠ *v*~*i*~) — the numbers of points connected by corresponding segment. It's guaranteed that no two segments connect the same pair of points.
