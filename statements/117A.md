...
Next *n* lines contain information about the participants in the form of three space-separated integers *s*~*i*~ *f*~*i*~ *t*~*i*~ (1 ≤ *s*~*i*~, *f*~*i*~ ≤ *m*, 0 ≤ *t*~*i*~ ≤ 10^8^), described in the problem statement.
