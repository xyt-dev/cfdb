...
For hacking you should write numbers *n* and *k* (2 ≤ *k* ≤ *n* ≤ 10^5^) in the first line and, for describing dishes Noora ordered, *k* different integers *a*~1~, *a*~2~, ..., *a*~*k*~ (1 ≤ *a*~*i*~ ≤ *n*), written in ascending order in the second line. Of course, solution you want to hack won't be able to read the numbers of ordered dishes.
