...
Each of the next *N* lines contains two integers *X*~*i*~ and *Y*~*i*~ (0 ≤ *X*~*i*~, *Y*~*i*~ ≤ 10^6^) representing the coordinates of the stages. There are no three or more collinear stages.
