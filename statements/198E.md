...
Next *n* lines contain the grippers' descriptions: the *i*-th line contains five integers *x*~*i*~, *y*~*i*~, *m*~*i*~, *p*~*i*~, *r*~*i*~ ( - 10^9^ ≤ *x*~*i*~, *y*~*i*~ ≤ 10^9^, 1 ≤ *m*~*i*~, *p*~*i*~, *r*~*i*~ ≤ 10^9^) — the *i*-th gripper's coordinates and features.
