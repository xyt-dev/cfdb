# F1. Monotone Monochrome Matrices (Medium Version)
...
This is the medium version of the problem. The difference between the versions is that in this version, the constraints on $n$ and $q$ are larger. You can hack only if you solved all versions of this problem.
...
The first line of each test case contains two integers $n$ and $q$ ($2 \le n \le 200\,000$, $1 \le q \le \min(n^2,200\,000)$).
