...
The first line contains a number *n* (3 ≤ *n* ≤ 5000) — the number of inhabited planets in the galaxy. The next *n* lines contain integer coordinates of the planets in format "*x*~*i*~ *y*~*i*~ *z*~*i*~" ( - 10^4^ ≤ *x*~*i*~, *y*~*i*~, *z*~*i*~ ≤ 10^4^).
