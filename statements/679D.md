...
You don't know much about Limak's current location. You assume that he is in one of *n* cities, chosen uniformly at random (each city with probability

![](images/679D_1.png)

). You decided for the following plan:
...
![](images/679D_3.png)
 ...
 Limak is in this city and BCD tells you that the distance is 0. You should try to catch him now and you win for sure.
 - With probability

![](images/679D_4.png)

 the distance is 1 because Limak is in city 2 or city 3. In this case you should wait for the second day.
...
![](images/679D_5.png)
 ...
 that Limak was in city 2 and then went to city 3.
 -
...
You loose only if Limak was in city 2 first and then he moved to city 3. The probability of loosing is
