...
The following *n* lines contains two integers each *x*~*i*~, *a*~*i*~ ( - 10^5^ ≤ *x*~*i*~ ≤ 10^5^, *x*~*i*~ ≠ 0, 1 ≤ *a*~*i*~ ≤ 10^5^), representing the position of the *i*-th tree and number of apples on it.
