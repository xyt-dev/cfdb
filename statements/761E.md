...
Otherwise, the first line should contain "YES". The next *n* lines should contain the pair of integers *x*~*i*~, *y*~*i*~ (|*x*~*i*~|, |*y*~*i*~| ≤ 10^18^) — the coordinates of the point which corresponds to the *i*-th vertex of the tree.
