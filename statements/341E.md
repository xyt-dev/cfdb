...
The first line of the input contains integer *n* (3 ≤ *n* ≤ 1000). The next line contains *n* non-negative integers: *a*~1~, *a*~2~, ..., *a*~*n*~ — sequence elements. It is guaranteed that sum of all numbers in sequence *a* is up to 10^6^.
