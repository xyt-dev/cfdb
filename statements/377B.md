...
The next line contains *m* space-separated integers *a*~1~, *a*~2~, ..., *a*~*m*~ (1 ≤ *a*~*i*~ ≤ 10^9^) — the bugs' complexities.

The next line contains *n* space-separated integers *b*~1~, *b*~2~, ..., *b*~*n*~ (1 ≤ *b*~*i*~ ≤ 10^9^) — the levels of the students' abilities.

The next line contains *n* space-separated integers *c*~1~, *c*~2~, ..., *c*~*n*~ (0 ≤ *c*~*i*~ ≤ 10^9^) — the numbers of the passes the students want to get for their help.
