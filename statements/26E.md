...
In the first line of the input you will be given two space separated integers *N* (1 ≤ *N* ≤ 100) and *W* ( - 10^9^ ≤ *W* ≤ 10^9^). In the second line there are *N* space separated integers *n*~*i*~ (1 ≤ *n*~*i*~ ≤ 1000).
