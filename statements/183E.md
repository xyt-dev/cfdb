...
Then *n* lines follow, each line will contain a single positive integer not exceeding

![](images/183E_1.png)

 denoting the allowance of a kid in rubles. The allowances are given in order from kid 1 to kid *n*.
