...
The second line contains $m$ distinct integers $p_1, p_2, \ldots, p_m$ ($1 \le p_1 \lt p_2 \lt \ldots \lt p_m \le n$) — the indices of special items which should be discarded.
