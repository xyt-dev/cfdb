...
- the first monster can't eat the second monster because *a*~1~ = 1 is not greater than *a*~2~ = 2;
- the second monster can't eat the third monster because *a*~2~ = 2 is not greater than *a*~3~ = 2;
...
The second line contains *n* integers *a*~1~, *a*~2~, ..., *a*~*n*~ (1 ≤ *a*~*i*~ ≤ 10^6^) — the initial weights of the monsters.

The third line contains single integer *k* (1 ≤ *k* ≤ *n*) — the number of monsters in the queue after the joke.

The fourth line contains *k* integers *b*~1~, *b*~2~, ..., *b*~*k*~ (1 ≤ *b*~*j*~ ≤ 5·10^8^) — the weights of the monsters after the joke.
