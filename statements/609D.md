...
Second line contains *n* integers *a*~*i*~ (1 ≤ *a*~*i*~ ≤ 10^6^) — the cost of one dollar in burles on *i*-th day.

Third line contains *n* integers *b*~*i*~ (1 ≤ *b*~*i*~ ≤ 10^6^) — the cost of one pound in burles on *i*-th day.

Each of the next *m* lines contains two integers *t*~*i*~, *c*~*i*~ (1 ≤ *t*~*i*~ ≤ 2, 1 ≤ *c*~*i*~ ≤ 10^6^) — type of the gadget and it's cost. For the gadgets of the first type cost is specified in dollars. For the gadgets of the second type cost is specified in pounds.
