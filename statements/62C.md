...
The first input line contains a single integer *n* (0 ≤ *n* ≤ 100). It is the number of spots on the cat's fur. The *i*-th of the last *n* lines contains 6 integers: *x*~1*i*~, *y*~1*i*~, *x*~2*i*~, *y*~2*i*~, *x*~3*i*~, *y*~3*i*~. They are the coordinates of the *i*-th triangular spot (0 < *x*~*ji*~, *y*~*ji*~ < 10^5^).
