...
Each of the next *n* lines contains two integers *x*~*i*~ and *y*~*i*~ ( - 10^8^ ≤ *x*~*i*~, *y*~*i*~ ≤ 10^8^) — the coordinates of the *i*-th point. It is guaranteed that no two points coincide.
