...
The second line of the input contains *n* integers, *x*~1~, *x*~2~, ..., *x*~*n*~ ( - 10^8^ ≤ *x*~*i*~ ≤ 10^8^) in no particular order.
...
![](images/596D_2.png)
 ...
 1. Both trees falls left. This can either happen with the right tree falling left first, which has

![](images/596D_3.png)

 probability (also knocking down the left tree), or the left tree can fall left and then the right tree can fall left, which has
