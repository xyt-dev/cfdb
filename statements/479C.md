...
Each of the next *n* lines contains two positive space-separated integers *a*~*i*~ and *b*~*i*~ (1 ≤ *b*~*i*~ < *a*~*i*~ ≤ 10^9^) — the date of the exam in the schedule and the early date of passing the *i*-th exam, correspondingly.
