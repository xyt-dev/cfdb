...
Each of the following *t* input lines contains four space-separated integers *k*~*i*~, *l*~*i*~, *r*~*i*~ and *p*~*i*~ (1 ≤ *k*~*i*~ ≤ 10^6^; 0 ≤ *l*~*i*~ ≤ *r*~*i*~ ≤ 10^18^; 2 ≤ *p*~*i*~ ≤ 10^9^) — the numbers, chosen by the Great Mushroom King and the prime module, correspondingly.
