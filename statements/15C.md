...
The first line of the input contains one integer number *n* (1 ≤ *n* ≤ 10^5^) — the amount of quarries. Then there follow *n* lines, each of them contains two space-separated integers *x*~*i*~ and *m*~*i*~ (1 ≤ *x*~*i*~, *m*~*i*~ ≤ 10^16^) — the amount of stones in the first dumper of the *i*-th quarry and the number of dumpers at the *i*-th quarry.
