...
Your output should consist of $t$ lines. Each line should consist of two integers $a$ and $b$ ($2 \le a \lt b \le P$). If there are multiple possible solutions, print any.
