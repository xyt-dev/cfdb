...
The first line of the input contains integer *n* (3 ≤ *n* ≤ 100). The second line contains *n* space-separated distinct integers *a*~1~, *a*~2~, ..., *a*~*n*~ (|*a*~*i*~| ≤ 10^3^) — the array elements.
