...
You are given $n$ positive integers $s_1 \lt s_2 \lt \ldots \lt s_n$. $f(x)$ is defined as the number of $i$ ($1\leq i\leq n$) that exist non-negative integers $p_i, q_i$ such that:
...
The second line of each test case contains $n$ positive integers $s_1,s_2,\ldots,s_n$ ($1\leq s_1 \lt s_2 \lt \ldots \lt s_n \leq 10^7$).
