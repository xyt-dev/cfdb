...
- The following $k$ integers $a_1, a_2, \ldots, a_k$ ($1 \le a_1 \lt a_2 \lt \ldots \lt a_k \le n$) denote the starting positions of the substrings that match the string $s$.
