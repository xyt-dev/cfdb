...
Each of the next $n$ lines contains 5 numbers $a_i$ ($1 \le a_i \le 100, a_i \lt a_{i+1}$) — the cards in the hand. It is guaranteed that each possible set of 5 cards has an equal probability of being chosen.
