...
The second line contains *n* space-separated integers *a*~*i*~ (0 ≤ *a*~*i*~ ≤ 10^9^), where *a*~*i*~ is the number of Berland dollars of a man standing on the *i*-th position in the line. The positions are numbered starting from the end of the line.
