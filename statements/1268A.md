...
Also, you are given a positive integer $k \lt n$.
...
The first line of input contains two integers $n, k$ ($2 \leq n \leq 200\,000, 1 \leq k \lt n$): the number of digits in $x$ and $k$.
