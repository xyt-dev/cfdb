...
The third line contains *m* positive integers *a*~1~, *a*~2~, ..., *a*~*m*~ (1 ≤ *a*~*i*~ ≤ 10^5^), where *a*~*i*~ is the number of days that are needed to prepare before passing the exam on the subject *i*.
