...
$^{\text{∗}}$The XOR-sum of an array $x_1, x_2, \ldots, x_y$ is equal to $x_1 \oplus x_2 \oplus x_3 \ldots x_{y-1} \oplus x_y$ where $\oplus$ denotes the [bitwise XOR operation](<https://en.wikipedia.org/wiki/Bitwise_operation#XOR>).
