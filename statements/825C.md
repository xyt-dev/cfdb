...
Makes has chosen *n* problems to solve on Decoforces with difficulties *a*~1~, *a*~2~, ..., *a*~*n*~. He can solve these problems in arbitrary order. Though he can solve problem *i* with difficulty *a*~*i*~ only if he had already solved some problem with difficulty
...
The second line contains *n* space-separated integer numbers *a*~1~, *a*~2~, ..., *a*~*n*~ (1 ≤ *a*~*i*~ ≤ 10^9^).
