...
Each of the next *m* lines contains *n* non-negative integers, the *j*-th number in the *i*-th line *a*~*ij*~ (1 ≤ *j* ≤ *n*, 1 ≤ *i* ≤ *m*, 0 ≤ *a*~*ij*~ ≤ 10^9^) denotes the number of votes for candidate *j* in city *i*.
