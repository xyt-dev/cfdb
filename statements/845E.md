...
Each of the next *k* lines contain two integers *x*~*i*~ and *y*~*i*~ (1 ≤ *x*~*i*~ ≤ *n*, 1 ≤ *y*~*i*~ ≤ *m*) — coordinates of the *i*-th center of ignition. It is guaranteed that the locations of all centers of ignition are distinct.
