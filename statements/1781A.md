...
The second line contains four integers $a$, $b$, $f$, $g$ ($0 \lt a, f \lt w$; $0 \lt b, g \lt d$): the laptop is located on the floor at point $(a, b)$, while the projector is hanging on the ceiling right above point $(f, g)$.
