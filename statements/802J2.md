# J2. Send the Fool Further! (medium)
...
The first line contains two space-separated integers – the number of friends *n* (

![](images/802J2_1.png)

) and the parameter *k* (1 ≤ *k* ≤ 10^5^). The next *n* - 1 lines each contain three space-separated integers *u*, *v* and *c* (0 ≤ *u*, *v* ≤ *n* - 1, 1 ≤ *c* ≤ 10^4^) meaning that *u* and *v* are friends and the cost for traveling between *u* and *v* is *c*.
