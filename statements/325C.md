...
Each monster will have at least one split rule. Each split rule will have at least one diamond. The sum of *l*~*i*~ across all split rules will be at most 10^5^.
