...
- hard problems — Petya takes exactly $b$ minutes ($b \gt a$) to solve any hard problem.
...
The first line of each test case contains four integers $n, T, a, b$ ($2 \le n \le 2\cdot10^5$, $1 \le T \le 10^9$, $1 \le a \lt b \le 10^9$) — the number of problems, minutes given for the exam and the time to solve an easy and hard problem, respectively.
