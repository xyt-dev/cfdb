...
The first line of the input contains integer *n* (1 ≤ *n* ≤ 10^5^) — the number of the alarm clocks. The next *n* lines describe the clocks: the *i*-th line contains two integers *x*~*i*~, *y*~*i*~ — the coordinates of the *i*-th alarm clock (0 ≤ *x*~*i*~, *y*~*i*~ ≤ 100).
