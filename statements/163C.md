...
![](images/163C_1.png)
 ...
 The figure shows an example with two chocolates. One is located in the position *a*~1~ = *l* - *d*, and is now on the top half of the belt, the second one is in the position *a*~2~ = 2*l* - *d*, and is now on the bottom half of the belt.
...
The first line contains space-separated integers *n*, *l*, *v*~1~ and *v*~2~ (1 ≤ *n* ≤ 10^5^, 1 ≤ *l*, *v*~1~, *v*~2~ ≤ 10^9^) — the number of the chocolates, the length of the conveyor's visible part, the conveyor's speed and Anton's speed.
