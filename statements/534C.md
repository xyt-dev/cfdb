...
The first line contains two integers *n*, *A* (1 ≤ *n* ≤ 2·10^5^, *n* ≤ *A* ≤ *s*) — the number of dice and the sum of shown values where *s* = *d*~1~ + *d*~2~ + ... + *d*~*n*~.

The second line contains *n* integers *d*~1~, *d*~2~, ..., *d*~*n*~ (1 ≤ *d*~*i*~ ≤ 10^6^), where *d*~*i*~ is the maximum value that the *i*-th dice can show.
