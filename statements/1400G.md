...
Then $m$ lines follow, the $i$-th of them contains two integers $a_i$ and $b_i$ ($1 \le a_i \lt b_i \le n$) denoting that the mercenaries $a_i$ and $b_i$ hate each other. There are no two equal pairs in this list.
