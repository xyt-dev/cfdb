...
The first line contains integers *n* and *m* (1 ≤ *n*, *m* ≤ 2·10^5^). The second line contains *n* integers *a*~1~, *a*~2~, ..., *a*~*n*~ (*a*~*i*~ = -1, 1). Next *m* lines contain Eugene's queries. The *i*-th line contains integers *l*~*i*~, *r*~*i*~ (1 ≤ *l*~*i*~ ≤ *r*~*i*~ ≤ *n*).
