...
The next *m* lines contain three integers each, *x*~*i*~, *y*~*i*~, *r*~*i*~ — the coordinates of the center and the radius of the *i*-th circle. All coordinates are integers of at most 10^4^ in their absolute value. The radius is a positive integer of at most 10^4^.
