...
The second line contains $n$ integers $a_1, a_2, \dots, a_n$ ($a_1 = 0$, $0 \lt a_{i + 1} - a_i \le d + 1$) — coordinates of left corners of corresponding buildings in ascending order.

The third line contains single integer $m$ ($1 \le m \le 2 \cdot 10^5$) — the number of candidates.

The fourth line contains $m$ integers $x_1, x_2, \dots, x_m$ ($0 \le x_i \le a_n + 1$, $x_i \lt x_{i + 1}$) — the coordinates of bends you need to calculate terminal angles for in ascending order.
