...
If there doesn't exist such a data which let the given code get TLE, print "no solution" (without quotes); else print *n* lines, and the *i*-th line contains two integers *x*~*i*~, *y*~*i*~ (|*x*~*i*~|, |*y*~*i*~| ≤ 10^9^) representing the coordinates of the *i*-th point.
