...
The first line of input contains integer *n* (1 ≤ *n* ≤ 10^5^) — the number of segments. The *i*-th of the next *n* lines contains two integers *l*~*i*~ and *r*~*i*~ (0 ≤ *l*~*i*~ ≤ *r*~*i*~ ≤ 10^9^) — the borders of the *i*-th segment.
