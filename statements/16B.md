...
The first line of the input contains integer *n* (1 ≤ *n* ≤ 2·10^8^) and integer *m* (1 ≤ *m* ≤ 20). The *i* + 1-th line contains a pair of numbers *a*~*i*~ and *b*~*i*~ (1 ≤ *a*~*i*~ ≤ 10^8^, 1 ≤ *b*~*i*~ ≤ 10). All the input numbers are integer.
