...
Next *m* lines contain numbers *a*~*i*~, *b*~*i*~, *d*~*i*~ (1 ≤ *a*~*i*~, *b*~*i*~ ≤ *n*, 0 ≤ *d*~*i*~ ≤ 10^9^), representing flight number *i* from city *a*~*i*~ to city *b*~*i*~, accessible to only the clients who have made at least *d*~*i*~ flights.
