...
The first line contains five integers *t*, *s*~*x*~, *s*~*y*~, *e*~*x*~, *e*~*y*~ (1 ≤ *t* ≤ 10^5^,  - 10^9^ ≤ *s*~*x*~, *s*~*y*~, *e*~*x*~, *e*~*y*~ ≤ 10^9^). The starting location and the ending location will be different.
