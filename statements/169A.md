...
The next line contains a sequence of integers *h*~1~, *h*~2~, ..., *h*~*n*~ (1 ≤ *h*~*i*~ ≤ 10^9^), *h*~*i*~ is the complexity of the *i*-th chore. The numbers in the given sequence are not necessarily different.
