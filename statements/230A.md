...
The first line contains two space-separated integers *s* and *n* (1 ≤ *s* ≤ 10^4^, 1 ≤ *n* ≤ 10^3^). Then *n* lines follow: the *i*-th line contains space-separated integers *x*~*i*~ and *y*~*i*~ (1 ≤ *x*~*i*~ ≤ 10^4^, 0 ≤ *y*~*i*~ ≤ 10^4^) — the *i*-th dragon's strength and the bonus for defeating it.
