...
The first line contains two space-separated integers *n*, *d* (1 ≤ *n* ≤ 50, 1 ≤ *d* ≤ 10^4^) — the number of items on the market and John's sense of justice value, correspondingly. The second line contains *n* space-separated integers *c*~*i*~ (1 ≤ *c*~*i*~ ≤ 10^4^).
