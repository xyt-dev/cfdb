...
The input consists of five lines, each line contains five space-separated integers: the *j*-th number in the *i*-th line shows *g*~*ij*~ (0 ≤ *g*~*ij*~ ≤ 10^5^). It is guaranteed that *g*~*ii*~ = 0 for all *i*.
