...
Each of the following *n* lines contains three space-separated integers *l*~*i*~, *v*~*i*~, *r*~*i*~ (1 ≤ *l*~*i*~ ≤ *v*~*i*~ ≤ *r*~*i*~ ≤ 3·10^5^) — the minimum skill value of the workers that the *i*-th worker can work with, the *i*-th worker's skill and the maximum skill value of the workers that the *i*-th worker can work with.
