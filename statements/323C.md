...
The first line contains one integer *n* (1 ≤ *n* ≤ 10^6^), the number of elements in both permutations. The following line contains *n* integers, separated with spaces: *p*~1~, *p*~2~, ..., *p*~*n*~ (1 ≤ *p*~*i*~ ≤ *n*). These are elements of the first permutation. The next line contains the second permutation *q*~1~, *q*~2~, ..., *q*~*n*~ in same format.
...
- Suppose *l*~1~ = *min*(*f*(*a*), *f*(*b*)), *r*~1~ = *max*(*f*(*a*), *f*(*b*)), *l*~2~ = *min*(*f*(*c*), *f*(*d*)), *r*~2~ = *max*(*f*(*c*), *f*(*d*)).
