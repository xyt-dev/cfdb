...
The second line contains $n$ integers $x_1, \, x_2, \, \dots, \, x_n$ ($1 \le x_i \le 10^9$, $x_i + 1 \lt x_{i+1}$) — the $x$ coordinates of the purple bricks (centers of the bases), given in increasing order.
