...
The first line of input contains two integers $n$ and $k$ ($1 \leq k \lt n \leq 10^6$) — the number of districts in Panel, and the number of contestants the president wishes to remove, respectively.
