...
The first line contains integer *n* (1 ≤ *n* ≤ 10^5^) — the number of snowballs. The next line contains *n* integers — the balls' radii *r*~1~, *r*~2~, ..., *r*~*n*~ (1 ≤ *r*~*i*~ ≤ 10^9^). The balls' radii can coincide.
