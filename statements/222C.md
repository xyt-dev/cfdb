...
The second line contains *n* space-separated integers: *a*~1~, *a*~2~, ..., *a*~*n*~ (1 ≤ *a*~*i*~ ≤ 10^7^) — the numbers that are multiplied to produce the numerator.

The third line contains *m* space-separated integers: *b*~1~, *b*~2~, ..., *b*~*m*~ (1 ≤ *b*~*i*~ ≤ 10^7^) — the numbers that are multiplied to produce the denominator.

#### Output

Print the answer to the problem in the form, similar to the form of the input data. The number of values in the sets you print *n*~*out*~, *m*~*out*~ must satisfy the inequality 1 ≤ *n*~*out*~, *m*~*out*~ ≤ 10^5^, and the actual values in the sets *a*~*out*, *i*~ and *b*~*out*, *i*~ must satisfy the inequality 1 ≤ *a*~*out*, *i*~, *b*~*out*, *i*~ ≤ 10^7^.
