...
![](images/191E_1.png)
 ...
 — the number of soldiers in the detachment and the number of times somebody goes on duty.

The second line contains *n* space-separated integers *a*~*i*~, their absolute value doesn't exceed 10^9^ — the soldiers' reliabilities.
