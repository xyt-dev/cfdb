...
The first line contains three space-separated integers *n*, *k*, *d* (1 ≤ *n* ≤ 2·10^5^; 0 ≤ *k* ≤ 2·10^5^; 0 ≤ *d* ≤ 10^9^). The second line contains *n* space-separated integers: *a*~1~, *a*~2~, ..., *a*~*n*~ ( - 10^9^ ≤ *a*~*i*~ ≤ 10^9^) — the actual sequence.
