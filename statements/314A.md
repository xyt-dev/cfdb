...
The first line contains two integers *n*, *k* (1 ≤ *n* ≤ 2·10^5^,  - 10^9^ ≤ *k* ≤ 0). The second line contains *n* space-separated integers *a*~1~, *a*~2~, ..., *a*~*n*~ (1 ≤ *a*~*i*~ ≤ 10^9^) — ratings of the participants in the initial table.
