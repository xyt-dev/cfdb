...
The first line contains integer *m* (1 ≤ *m* ≤ 10^5^) — the number of discount types. The second line contains *m* integers: *q*~1~, *q*~2~, ..., *q*~*m*~ (1 ≤ *q*~*i*~ ≤ 10^5^).

The third line contains integer *n* (1 ≤ *n* ≤ 10^5^) — the number of items Maxim needs. The fourth line contains *n* integers: *a*~1~, *a*~2~, ..., *a*~*n*~ (1 ≤ *a*~*i*~ ≤ 10^4^) — the items' prices.
