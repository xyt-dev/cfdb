...
- Choose two random indices $i$ and $j$ such that $i \lt j$. Indices are chosen equally probable among all pairs of indices $(i, j)$ such that $1 \le i \lt j \le n$.
- If $a_i \gt a_j$, then swap elements $a_i$ and $a_j$.
...
It can be shown that the answer can be expressed as an irreducible fraction $\frac{p}{q}$, where $p$ and $q$ are integers and $q \not \equiv 0 \pmod{998\,244\,353}$. Output the integer equal to $p \cdot q^{-1} \bmod 998\,244\,353$. In other words, output such an integer $x$ that $0 \le x \lt 998\,244\,353$ and $x \cdot q \equiv p \pmod{998\,244\,353}$.
