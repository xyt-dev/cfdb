...
Next *n* lines will contain the coordinates of the vertices in the clockwise order of the polygon. On the *i*-th line are integers *x*~*i*~ and *y*~*i*~ (0 ≤ *x*~*i*~, *y*~*i*~ ≤ 10^6^) separated by a space.
