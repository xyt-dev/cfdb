...
![](images/954E_1.png)
 ...
 you set *i*-th tap to deliver exactly *x*~*i*~ ml of water per second, then the resulting temperature of water will be
...
The second line contains *n* integers *a*~1~, *a*~2~, ..., *a*~*n*~ (1 ≤ *a*~*i*~ ≤ 10^6^) where *a*~*i*~ is the maximum amount of water *i*-th tap can deliver per second.

The third line contains *n* integers *t*~1~, *t*~2~, ..., *t*~*n*~ (1 ≤ *t*~*i*~ ≤ 10^6^) — the temperature of water each tap delivers.
