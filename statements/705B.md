...
The second line contains *n* space separated integers *a*~1~, *a*~2~, ..., *a*~*n*~ (1 ≤ *a*~*i*~ ≤ 10^9^), *i*-th of them stands for the number of vertices in the cycle added before the *i*-th test.
