...
The first line of the input contains *n* (1 ≤ *n* ≤ 10^5^). Each of the next *n* - 1 lines contains two integers *a*~*i*~ and *b*~*i*~ (1 ≤ *a*~*i*~, *b*~*i*~ ≤ *n*; *a*~*i*~ ≠ *b*~*i*~) indicating there's an edge between vertices *a*~*i*~ and *b*~*i*~. It's guaranteed that the input graph is a tree.

The last line of the input contains a list of *n* space-separated integers *v*~1~, *v*~2~, ..., *v*~*n*~ (|*v*~*i*~| ≤ 10^9^).
