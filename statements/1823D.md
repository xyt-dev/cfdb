...
The second line of each test case contains $k$ integers $x_1, x_2, \dots, x_k$ ($3 \le x_1 \lt x_2 \lt \dots \lt x_k = n$) where $x_i$ is the length of the prefix in the $i$-th condition.
