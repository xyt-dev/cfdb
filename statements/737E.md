...
The second line contains *m* integers *p*~1~, *p*~2~, ..., *p*~*m*~ (1 ≤ *p*~*j*~ ≤ 10^6^), where *p*~*j*~ is the rent price for the second copy of the *j*-th machine.
