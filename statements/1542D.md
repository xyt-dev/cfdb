...
Each of the next $n$ lines begins with an operator + or -. If the operator is +, then it's followed by an integer $x$ ($1\le x \lt 998\,244\,353$). The $i$-th line of those $n$ lines describes the $i$-th element in $A$.
