...
The first line contains two integers *n* and *t* (1 ≤ *n* ≤ 1000, 1 ≤ *t* ≤ 1560). Then follow *n* lines, each containing 5 numbers: *scoreSmall*~*i*~, *scoreLarge*~*i*~, *timeSmall*~*i*~, *timeLarge*~*i*~, *probFail*~*i*~ (1 ≤ *scoreSmall*~*i*~, *scoreLarge*~*i*~ ≤ 10^9^, 1 ≤ *timeSmall*~*i*~, *timeLarge*~*i*~ ≤ 1560, 0 ≤ *probFail*~*i*~ ≤ 1).
