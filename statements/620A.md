...
The first line contains two integers *x*~1~, *y*~1~ ( - 10^9^ ≤ *x*~1~, *y*~1~ ≤ 10^9^) — the start position of the robot.

The second line contains two integers *x*~2~, *y*~2~ ( - 10^9^ ≤ *x*~2~, *y*~2~ ≤ 10^9^) — the finish position of the robot.
