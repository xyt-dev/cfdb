...
The first input line contains two space-separated integers *x*~*a*~, *y*~*a*~ (|*x*~*a*~|, |*y*~*a*~| ≤ 10^9^) — the coordinates of point *A*. The second line contains the coordinates of point *B* in the same form, the third line contains the coordinates of point *C*.
