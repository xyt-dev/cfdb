...
The first line contains two integers *n* and *m* (2 ≤ *n* ≤ 10^5^; 1 ≤ *m* ≤ 10^5^). The next line contains a sequence of integers *c*~1~, *c*~2~, ..., *c*~*n*~ (1 ≤ *c*~*i*~ ≤ 10^5^). The next *n* - 1 lines contain the edges of the tree. The *i*-th line contains the numbers *a*~*i*~, *b*~*i*~ (1 ≤ *a*~*i*~, *b*~*i*~ ≤ *n*; *a*~*i*~ ≠ *b*~*i*~) — the vertices connected by an edge of the tree.

Next *m* lines contain the queries. The *j*-th line contains two integers *v*~*j*~, *k*~*j*~ (1 ≤ *v*~*j*~ ≤ *n*; 1 ≤ *k*~*j*~ ≤ 10^5^).
