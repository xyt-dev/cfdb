...
The first line of input contains a single integer *n* (1 ≤ *n* ≤ 10^5^), the number of hills. The next *n* lines describe the hills. The *i*-th of them contains two space-separated integers *x*~*i*~, *y*~*i*~ (1 ≤ *x*~*i*~ ≤ 10^7^; 1 ≤ *y*~*i*~ ≤ 10^11^), the position and the height of the *i*-th hill. The hills are given in the ascending order of *x*~*i*~, i.e., *x*~*i*~ < *x*~*j*~ for *i* < *j*.

The next line of input contains a single integer *m* (1 ≤ *m* ≤ 10^5^), the number of teams. The next *m* lines describe the teams. The *i*-th of them contains two space-separated integers *a*~*i*~, *b*~*i*~ (1 ≤ *a*~*i*~, *b*~*i*~ ≤ *n*), the numbers of the hills where the climbers of the *i*-th team are located. It is possible that *a*~*i*~ = *b*~*i*~.
