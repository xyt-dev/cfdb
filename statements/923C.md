...
![](images/923C_2.png)
 ...
 denotes the [bitwise XOR operation](<https://en.wikipedia.org/wiki/Bitwise_operation#XOR>)) and stores this encrypted message *A*. Alice is smart. Be like Alice.
...
The second line contains *N* integers *A*~1~, *A*~2~, ..., *A*~*N*~ (0 ≤ *A*~*i*~ < 2^30^) representing the encrypted message.

The third line contains *N* integers *P*~1~, *P*~2~, ..., *P*~*N*~ (0 ≤ *P*~*i*~ < 2^30^) representing the permuted encryption key.
