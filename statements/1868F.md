...
Find the minimum number of operations you need to perform to make $a_i \lt 0$ for every $1\le i\le n$.
...
In the second example, it's already satisfied that $a_i \lt 0$ for every $1\le i\le n$. So you do not need to perform any operations.
