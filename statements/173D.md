...
The first line contains two integers *n* and *m* — the number of cities and bridges (3 ≤ *n* < 10^5^, *n* = 3*k*, 0 ≤ *m* ≤ 10^5^). Next *m* lines describe the bridges. The *i*-th line contains two integers *a*~*i*~ and *b*~*i*~ — the numbers of cities that are connected by the *i*-th bridge (1 ≤ *a*~*i*~, *b*~*i*~ ≤ *n*, *a*~*i*~ ≠ *b*~*i*~, 1 ≤ *i* ≤ *m*).
