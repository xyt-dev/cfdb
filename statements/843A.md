...
The second line of input data contains *n* different integers *a*~1~, *a*~2~, ..., *a*~*n*~ ( - 10^9^ ≤ *a*~*i*~ ≤ 10^9^) — the elements of the sequence. It is guaranteed that all elements of the sequence are distinct.
