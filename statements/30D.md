...
The first line contains two integers *n* and *k* (1 ≤ *n* ≤ 10^5^, 1 ≤ *k* ≤ *n* + 1) — amount of cities and index of the starting city. The second line contains *n* + 1 numbers *x*~*i*~. The third line contains *y*~*n* + 1~. All coordinates are integers and do not exceed 10^6^ by absolute value. No two cities coincide.
