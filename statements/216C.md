...
In the second line print *z* positive integers, separated by spaces: the *i*-th integer *a*~*i*~ (1 ≤ *a*~*i*~ ≤ 10^4^) should represent the number of the day, on which Vitaly should hire the *i*-th employee.
