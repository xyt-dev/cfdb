...
The next *k* lines contain the description of the matrix. The *i*-th line contains three space-separated integers *x*~*i*~, *y*~*i*~, *w*~*i*~ (1 ≤ *x*~*i*~,  *y*~*i*~ ≤  *n*; 0  ≤  *w*~*i*~  ≤ 10^9^). These numbers denote that *A*~*x*~*i*~, *y*~*i*~~ = *w*~*i*~. All the elements of the matrix except of the given elements are equal to 1.
