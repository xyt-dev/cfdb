...
- Jump to the $j$-th square and pay the cost $b_i$, where $j$ is the leftmost square that satisfies $j \gt i, p_j \gt p_i$. If there is no such $j$ then you can end the round and pay the cost $b_i$.
