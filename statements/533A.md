...
Then follows a line consisting of *n* positive integers *h*~1~, *h*~2~, ..., *h*~*n*~ (1 ≤ *h*~*i*~ ≤ 10^9^), where *h*~*i*~ is the height of the ceiling in the *i*-th cave.
...
The last line contains *k* integers *s*~1~, *s*~2~, ..., *s*~*k*~ (1 ≤ *s*~*j*~ ≤ 10^9^), where *s*~*j*~ is the *j*-th miner's height.
