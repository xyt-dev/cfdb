...
The first line contains an integer *n* (1 ≤ *n* ≤ 10^6^) showing how many numbers are in set *a*. The second line contains space-separated integers *a*~1~, *a*~2~, ..., *a*~*n*~ (1 ≤ *a*~*i*~ ≤ 10^12^). Please note, that given set can contain equal numbers.
