...
The first line contains two integers *n* and *m* (1 ≤ *n*, *m* ≤ 10^5^) — the number of array elements and the number of queries. The second line contains the sequence of integers *a*~1~, *a*~2~, ..., *a*~*n*~ (1 ≤ *a*~*i*~ ≤ 10^9^), where number *a*~*i*~ stands for the *i*-th array element.
