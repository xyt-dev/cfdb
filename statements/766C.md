...
The third line contains 26 integers *a*~1~, *a*~2~, ..., *a*~26~ (1 ≤ *a*~*x*~ ≤ 10^3^) — the maximum lengths of substring each letter can appear in.
...
Notice that "aab" is not a possible splitting because the letter 'a' appears in a substring of length 3, while *a*~1~ = 2.
