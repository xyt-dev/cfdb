...
Then *n* lines follow, each of them contains two integers *h*~*i*~, *t*~*i*~ ( - 10^9^ ≤ *h*~*i*~ < *t*~*i*~ ≤ 10^9^) — the *x*-coordinate of the head and tail of the *i*-th duck at the moment 0.
