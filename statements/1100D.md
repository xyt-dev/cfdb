...
The example is trimmed. The full initial positions of the rooks in the first test are available at [https://pastebin.com/qQCTXgKP](<https://pastebin.com/qQCTXgKP>). It is not guaranteed that they will behave as in the example.
