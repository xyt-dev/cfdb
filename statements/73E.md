...
The first line contains two integers *n* and *x* (0 ≤ *n* ≤ 10^5^, 2 ≤ *x* ≤ 10^9^). The second line contains integers *a*~*i*~ (1 ≤ *a*~*i*~ ≤ 10^9^). Some numbers among all *a*~*i*~ may be equal.
