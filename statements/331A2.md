...
The first line contains a single integer *n* — the initial number of trees in the woodland belt, 2 ≤ *n*. The second line contains space-separated integers *a*~*i*~ — the esthetic appeals of each tree. All esthetic appeals do not exceed 10^9^ in their absolute value.
