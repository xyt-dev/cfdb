...
Calculate the sum of $f(v, u)$ over all pairs of vertices $v$ and $u$ such that $1 \le v \lt u \le n$.
...
Print a single integer — the sum of $f(v, u)$ over all pairs of vertices $v$ and $u$ such that $v \lt u$.
