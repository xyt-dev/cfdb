...
The *i*-th of *n* following lines contains two integers *t*~*i*~ and *w*~*i*~ (0 ≤ *t*~*i*~ ≤ *w*~*i*~ ≤ 10^18^) — respectively the number of balloons and the weight of the *i*-th team. Limak is a member of the first team.
