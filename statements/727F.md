...
The second line of input contains *n* integers *a*~1~, *a*~2~, ..., *a*~*n*~ ( - 10^9^ ≤ *a*~*i*~ ≤ 10^9^) — the qualities of the problems in order of increasing difficulty.

The third line of input contains *m* integers *b*~1~, *b*~2~, ..., *b*~*m*~ (0 ≤ *b*~*i*~ ≤ 10^15^) — the guesses of the current coordinator's mood *q*.
