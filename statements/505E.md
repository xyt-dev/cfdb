...
The following *n* lines describe the properties of the bamboos. The *i*-th of them (1 ≤ *i* ≤ *n*) contains two space-separated integers *h*~*i*~ and *a*~*i*~ (0 ≤ *h*~*i*~ ≤ 10^9^, 1 ≤ *a*~*i*~ ≤ 10^9^), denoting the initial height and the growth rate of the *i*-th bamboo, respectively.
