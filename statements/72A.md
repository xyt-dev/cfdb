...
The positive integer *x* is rich, if there exists some set of distinct numbers *a*~1~, *a*~2~, ..., *a*~*m*~ such that

![](images/72A_1.png)

. In addition: every *a*~*i*~ should be either a prime number, or equal to 1.
