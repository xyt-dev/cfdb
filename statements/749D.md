...
Each of the following *n* lines contains two integers *a*~*i*~ and *b*~*i*~ (1 ≤ *a*~*i*~ ≤ *n*, 1 ≤ *b*~*i*~ ≤ 10^9^, *b*~*i*~ < *b*~*i* + 1~) — the number of participant who made the *i*-th bid and the size of this bid.
