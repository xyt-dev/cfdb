...
Then *n* lines follow, each of them contains three integers: *s*~*i*~, *f*~*i*~, *t*~*i*~ (1 ≤ *s*~*i*~, *f*~*i*~, *t*~*i*~ ≤ 10^9^, *s*~*i*~ < *f*~*i*~) — the description of the buses. It is guaranteed that all *t*~*i*~-s are different.

Then *m* lines follow, each of them contains three integers: *l*~*i*~, *r*~*i*~, *b*~*i*~ (1 ≤ *l*~*i*~, *r*~*i*~, *b*~*i*~ ≤ 10^9^, *l*~*i*~ < *r*~*i*~) — the Bertown citizens' description. Some *b*~*i*~-s could coincide.
