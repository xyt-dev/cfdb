...
The first line contains integer *n* (1 ≤ *n* ≤ 10^5^) — the number of students in the group. The second line contains sequence of different integers *a*~1~, *a*~2~, ..., *a*~*n*~ (1 ≤ *a*~*i*~ ≤ *n*). The third line contains the sequence of different integers *b*~1~, *b*~2~, ..., *b*~*n*~ (1 ≤ *b*~*i*~ ≤ *n*).
