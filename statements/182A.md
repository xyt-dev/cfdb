...
The second line contains four space-separated integers: *A*~*x*~, *A*~*y*~, *B*~*x*~, *B*~*y*~ ( - 10^4^ ≤ *A*~*x*~, *A*~*y*~, *B*~*x*~, *B*~*y*~ ≤ 10^4^) — the coordinates of points *А* and *B*. It is guaranteed that points *A* and *B* do not belong to any trench.

The third line contains a single integer: *n* (1 ≤ *n* ≤ 1000), — the number of trenches.

Each of the following *n* lines contains four space-separated integers: *x*~1~, *y*~1~, *x*~2~, *y*~2~ ( - 10^4^ ≤ *x*~*i*~, *y*~*i*~ ≤ 10^4^) — the coordinates of ends of the corresponding trench.
