...
The second line contains *n* integers *a*~*i*~ ( - 10^9^ ≤ *a*~*i*~ ≤ 10^9^) — the number written in the *i*-th cell. The numbers are given for cells in order from 1 to *n*. Some of numbers *a*~*i*~ can be equal.
