...
It is guaranteed that if we have Roman numerals included the number would be less than or equal to 3000~10~ and it won't be 0. In any other case the number won't be greater than 10^15^~10~.
