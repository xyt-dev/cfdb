...
- Before the first operation, $b = [\,]$. You choose $p = 0$ and replace $b$ with $[\, \underline{0} \,]$
- On the second operation you choose $p = 0$ and replace $b$ with $[\, \underline{0}, 0 \,]$.
- On the third operation you choose $p = 2$ and replace $b$ with $[\, 1, 1, \underline{0} \,]$.
- On the fourth operation you choose $p = 1$ and replace $b$ with $[\, 0, \underline{0}, 1, 0 \,]$.
- On the fifth operation you choose $p = 3$ and replace $b$ with $[\, 1, 1, 0, \underline{0}, 0 \,]$.
