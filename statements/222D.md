...
The second line contains *n* space-separated integers: *a*~1~, *a*~2~, ..., *a*~*n*~ (0 ≤ *a*~*i*~ ≤ 10^5^) — the participants' points in the first tour.

The third line contains *n* space-separated integers: *b*~1~, *b*~2~, ..., *b*~*n*~ (0 ≤ *b*~*i*~ ≤ 10^5^) — the participants' points in the second tour.
