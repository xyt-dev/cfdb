...
The first line contains the number of universities *t*, (1 ≤ *t* ≤ 1000) Each of the next *t* lines contain three space-separated integers: *n*~*i*~, *l*~*i*~, *r*~*i*~ (1 ≤ *n*~*i*~, *l*~*i*~, *r*~*i*~ ≤ 10^9^; *l*~*i*~ ≤ *r*~*i*~).
