...
The first line contains two space-separated integers — *n* and *k* (1 ≤ *n*, *k* ≤ 10^5^). Next *n* lines contain array *a*. The *i*-th line contains a non-empty string *a*~*i*~, consisting of lowercase English letter. The total length of all strings *a*~*i*~ does not exceed 10^5^.
