...
- 1 i — print *t*~*i*~ in a separate line.
- 2 a b x — for

![](images/679E_1.png)

 set *t*~*i*~ to *x*. It's guaranteed that *x* is a good number.
- 3 a b x — for

![](images/679E_2.png)

 increase *t*~*i*~ by *x*. After this repeat the process while at least one *t*~*i*~ is bad.
...
The second line of the input contains *n* integers *t*~1~, *t*~2~, ..., *t*~*n*~ (2 ≤ *t*~*i*~ ≤ 10^9^) — initial elements of Limak's sequence. All *t*~*i*~ are good.
