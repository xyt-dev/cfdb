...
You are given an integer $k$. Find the largest integer $x$, where $1 \le x \lt k$, such that $x! + (x - 1)!^\dagger$ is a multiple of $^\ddagger$ $k$, or determine that no such $x$ exists.
