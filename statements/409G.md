...
Each of the next *n* lines contains two real coordinates *x*~*i*~ and *y*~*i*~ of the

![](images/409G_1.png)

 point, specified with exactly 2 fractional digits. All coordinates are between  - 1000 and 1000, inclusive.
