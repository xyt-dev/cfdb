...
Let d(x) be a number of divisors of x, and f(x) be the product of divisors. Let *x* = *p*<sub>1</sub><sup>α<sub>1</sub></sup>*p*<sub>2</sub><sup>α<sub>2</sub></sup>... *p*<sub>*n*</sub><sup>α<sub>*n*</sub></sup>, then *d*(*x*) = (α<sub>1</sub> + 1)·(α<sub>2</sub> + 1)... (α<sub>*n*</sub> + 1) 
...
Given secquence (*p*<sub>1</sub>, *k*<sub>1</sub>),  (*p*<sub>2</sub>, *k*<sub>2</sub>), ...,  (*p*<sub>*n*</sub>, *k*<sub>*n*</sub>)
 (*p*<sub>*i*</sub> — distinct primes) and q queries (l, r) to calculate *f*(*p*<sub>*l*</sub><sup>*k*<sub>*l*</sub></sup>·*p*<sub>*l* + 1</sub><sup>*k*<sub>*l* + 1</sub></sup>... *p*<sub>*r*</sub><sup>*k*<sub>*r*</sub></sup>)%*MOD*.
