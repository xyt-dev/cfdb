...
#### [Problem A (div2)](<https://codeforces.com/problemset/problem/669/A>):
...
#### [Problem B (div2)](<https://codeforces.com/problemset/problem/669/B>):
...
#### [Problem A(div1)/C(div2)](<https://codeforces.com/problemset/problem/669/C>):
...
#### [Problem B(div1)/D(div2)](<https://codeforces.com/problemset/problem/669/D>):
...
#### [Problem C(div1)](<https://codeforces.com/problemset/problem/641/D>):
...
Another way was to use data structure from std library, described [here](<https://codeforces.com/blog/entry/11080>). For each element we have two trees: remove times and add times. Then by getting order of the time in remove and add tree we can calculate the answer.
#### [Problem E(div1)](<https://codeforces.com/problemset/problem/641/F>):

Let's build for both 2-SAT formulas [implication graph](<https://en.wikipedia.org/wiki/Implication_graph>) and let's find strong connected components in this graph. If both of the formulas are not satisfiable then the answer is SIMILAR. If only one formula is not satisfiable then we can find an answer for the second one and output it.
...
#### [Problem F(div1)](<https://codeforces.com/problemset/problem/641/G>):
...
Check out details in the [author solution](<https://gist.github.com/winger/612429959a953104d7b05b72f290c8a8>).
