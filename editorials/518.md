...
At first let's take two sums *a*<sub>1</sub> + *a*<sub>2</sub> + ... + *a*<sub>*k*</sub> and *a*<sub>2</sub> + *a*<sub>3</sub> + ... + *a*<sub>*k* + 1</sub>. It is correct that *a*<sub>1</sub> + *a*<sub>2</sub> + ... + *a*<sub>*k*</sub> < *a*<sub>2</sub> + *a*<sub>3</sub> + ... + *a*<sub>*k* + 1</sub>. If move from right to left all elements apart from *a*<sub>*k* + 1</sub>, all of them will reduce and will left only *a*<sub>1</sub> < *a*<sub>*k* + 1</sub>. If write further all sums we will obtain that sequence disintegrate on *k* disjoint chains: *a*<sub>1</sub> < *a*<sub>*k* + 1</sub> < *a*<sub>2*k* + 1</sub> < *a*<sub>3*k* + 1</sub>..., *a*<sub>2</sub> < *a*<sub>*k* + 2</sub> < *a*<sub>2*k* + 2</sub> < *a*<sub>3*k* + 2</sub>..., ..., *a*<sub>*k*</sub> < *a*<sub>2*k*</sub> < *a*<sub>3*k*</sub>....
