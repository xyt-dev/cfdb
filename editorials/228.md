...
This problem could be solved using dynamic programming. State *z*[*x*][*y*][*st*][*mask*] means if the square with upper left corner (*x*, *y*) is fractal with nesting level *st* and colors *mask*. The value *z*[*x*][*y*][*st*][*mask*] is 0 or 1. There are *O*(*N*^2^·*Log*(*N*)·2^4^) states in this dynamic programming.
