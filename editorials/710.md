...
Let's write down the equation describing the problem: *a*~1~*k* + *b*~1~ = *a*~2~*l* + *b*~2~ → *a*~1~*k* - *a*~2~*l* = *b*~2~ - *b*~1~. So we have linear Diofant equation with two variables: *Ax* + *By* = *C*, *A* = *a*~1~, *B* =  - *a*~2~, *C* = *b*~2~ - *b*~1~. The solution has the form: 
