...
When do we get a paradox? Where we have two problems *i* and *j* that *p*<sub>*i*</sub> < *p*<sub>*j*</sub> (*p*<sub>*i*</sub> was worth less points) we solved problem *i* much earlier and later we got less points for problem *p*<sub>*j*</sub>. We can now use some segment tree or sort problems by *p*<sub>*i*</sub> and check whether there is a pair of problems with inequalities we are looking for — *p*<sub>*i*</sub> < *p*<sub>*j*</sub> and *max*<sub>*i*</sub> > *min*<sub>*j*</sub> where *max*<sub>*i*</sub> and *min*<sub>*j*</sub> we found in the previous paragraph.
