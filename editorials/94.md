...
. Let's learn how to calculate the sum *E* + *A* + ... + *A*^*N*^ quickly.
...
And the others who sensed that something was wrong memorized the answers for small *n* and all *a*~*i*~. For example, you can see solution by [rng_58](<../../../profile/rng_58>) who won the contest, or this solution: [http://pastebin.com/4kcfJdAi](<http://pastebin.com/4kcfJdAi>).

[anonymous](<../../../profile/anonymous>), the author of this problem, wrote his thoughts about it there: [http://codeforces.com/blog/entry/2216](<../2216>) (but now there's only russian version). His solution works even if *n* = 10^15^ and it can be viewed here: [http://codeforces.com/problemset/status/93/E?order=BY_CONSUMED_TIME_ASC](<https://codeforces.com/problemset/status/93/E?order=BY_CONSUMED_TIME_ASC>). It seems that any solution submitted during the contest would get TLE if *n* = 10^15^.
