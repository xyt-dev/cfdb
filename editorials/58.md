...
Solution with work time *O*(*n*<sup>2</sup>): we run down which tree we will fix, determine required height of the first tree and then relax answer.
...
Under construction. The main idea is 3D dynamic with O(10<sup>2</sup>) transition.
