<!-- url: https://codeforces.com/blog/entry/59105 -->
...
[37617481](<https://codeforces.com/contest/965/submission/37617481>)

## 965B - Battleship

Let's compute for each cell four values: the number of cells where a part of the ship can be located to the right ($r$), to the left ($l$), up ($u$) and down ($d$), including the cell itself. Then, if $k \gt 1$, then there are $\min(k, \max(0, l + r - k)) + \min(k, \max(0, u + d - k))$ positions of the ship containing this cell, and if $k = 1$ it's easy to check whether this value is $1$ or $0$. After that you should just print the maximum among all cells. This solution works in $O(n^3)$.

[37617515](<https://codeforces.com/contest/965/submission/37617515>)
...
[37617552](<https://codeforces.com/contest/965/submission/37617552>)
...
[37617576](<https://codeforces.com/contest/965/submission/37617576>)
...
[37617599](<https://codeforces.com/contest/965/submission/37617599>)
