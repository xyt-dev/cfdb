...
The second esoteric problem had a [Chef](<http://progopedia.com/language/chef/>) program as the statement. You had only to figure out what it does and do it in any regular language. It turns out that this program reads N followed by N numbers *a*~1~, *a*~2~, ..., *a*~*N*~ and calculated the sum *i* * *a*~*i*~.
