...
As said in the statement, the thickness of each book is either 1 or 2. Think about when we want to arrange *v*~1~ books of thickness 1 and *v*~2~ books of thickness 2 vertically and arrange all other *n* - *v*~1~ - *v*~2~ books horizontally above them to achieve a configuration with total thickness of vertical books equal to *v*~1~ + 2*v*~2~. Is it possible to find such arrangement? Because the total thickness of vertical books is fixed it's good to calculate the minimum possible total width of horizontal books. As the width of a book doesn't matter in vertical arrangement it's good to use the books with shorter width horizontally and the ones with longer width vertically. So pick out *v*~1~ books with longest width among books of thickness 1 and do the same with books of thickness 2. The sum of width of *n* - *v*~1~ - *v*~2~ remaining books should be at most *v*~1~ + 2*v*~2~.

The solution would be to try the things we explained above for all possible values of *v*~1~ and *v*~2~. And print the best answer. :)
