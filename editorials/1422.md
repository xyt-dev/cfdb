<!-- url: https://codeforces.com/blog/entry/83452 -->
Good mood and pure thoughts to everyone who comes here.

## 1422A - Fence
Author [aropan](<https://codeforces.com/profile/aropan>)
Solution [94875319](<https://codeforces.com/contest/1422/submission/94875319>)

**Tutorial**

A quadrilateral can be built when $ max (a, b, c, d) \lt a + b + c + d - max (a, b, c, d) $, that is, the sum of the minimum three numbers is greater than the maximum. To do this, you could choose $ max (a, b, c) $ or $ a + b + c - 1 $ as $ d $.


## 1422B - Nice Matrix
Author [andrew](<https://codeforces.com/profile/andrew>)
Solution [94875245](<https://codeforces.com/contest/1422/submission/94875245>)
...
## 1422E - Minlexes
Author [aropan](<https://codeforces.com/profile/aropan>)
Solution [94875558](<https://codeforces.com/contest/1422/submission/94875558>)

**Tutorial**

Let's find the answer $ans_i$ for all suffixes, starting with the smallest in length. $ ans_n $ is equal to an empty string. Then if $ s_i = s_{i + 1} $ ($ 0 \le i + 1 \lt n $), then $ ans_i = min (s_i + ans_{i + 1}, ans_{i + 2}) $, and otherwise $ ans_i = s_i + ans_{i + 1} $. To quickly find minimum of two strings, they can be stored as "binary lifts"  – $ next_ {i, j} $ will be equal to the position in the string $s$, on which the $2 ^ j$ character $ ans_i $ will be located, and $ hash_{i, j} $  – hash from the prefix $ ans_i $ of length $ 2 ^ j $. Values for $ (i, j) $ can be obtained from $ (i, j-1) $ and $ (i + 2 ^ {j-1}, j-1) $. To restore the answer, $ next_ {i, j} $ will be enough for us, and for simplicity we can additionally store the length of each answer.


## 1422F - Boring Queries
Author [andrew](<https://codeforces.com/profile/andrew>)
Solution [94875580](<https://codeforces.com/contest/1422/submission/94875580>), author's solution with persistent segment tree [94875295](<https://codeforces.com/contest/1422/submission/94875295>)
