...
Well, let's fix *j*-th east point (1 ≤ *j* ≤ *m*). Now consider how changes total distance depending on chosing the west point. The best point is intersection of lines *OB*<sub>*j*</sub> и *x* = *a*:
...
Stupid emulation is very slow. It has complexity *O*(*nm*<sup>2</sup>) and answer can be about 10<sup>10</sup>. You should speed up stupid emulation using following way.
