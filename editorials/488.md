...
## 488B - Candy Boxes
Let's sort the four numbers in ascending order: *a*, *b*, *c*, *d* (where *x*<sub>1</sub>, *x*<sub>2</sub>, *x*<sub>3</sub>, *x*<sub>4</sub> are used in problem statement). So
...
So *a*<sub>*n*</sub> must be 0 from which we know *a*<sub>1*a*</sub><sub>2</sub>... *a*<sub>*n* - 1</sub> = (*n* - 1)!. But for any composite number *n* > 4 we have
...
For any prime number *n*, let *a*<sub>*i*</sub> be

![](eimages/488_7.png)

. If there are two same number *a*<sub>*i*</sub>, *a*<sub>*j*</sub>. Then we get *i* / (*i* - 1) ≡ *j* / (*j* - 1) which leads to *i* ≡ *j*, which is a contradiction. So all *n* numbers will occur exactly once. And this is a solution.
...
If *p* = *q*, note that *n* > 4 so 2*p* < *n*, we have *p*<sup>2</sup>|(*n* - 1)!
