<!-- url: https://codeforces.com/blog/entry/124757 -->
## 1921A - Square

Idea: [goncharovmike](<https://codeforces.com/profile/goncharovmike>), prepared: [pashka](<https://codeforces.com/profile/pashka>)
...
Idea: [pashka](<https://codeforces.com/profile/pashka>), prepared: [ikrpprppp](<https://codeforces.com/profile/ikrpprppp>)
...
Idea: [step_by_step](<https://codeforces.com/profile/step_by_step>), prepared: [step_by_step](<https://codeforces.com/profile/step_by_step>), [Vladosiya](<https://codeforces.com/profile/Vladosiya>)

**Tutorial**

The most challenging part of this problem was probably carefully understanding the problem statement.

The problem can be reduced to the following. There are $n$ time intervals: from 0 to $m_1$, from $m_1$ to $m_2$, ..., from $m_{n-1}$ to $m_n$. For each interval, we need to find a way to spend as little charge of the phone as possible, and check that the total amount of charge we spend is less than the initial charge of the phone.
...
Idea: [Vitaly239239](<https://codeforces.com/profile/Vitaly239239>), prepared: [pashka](<https://codeforces.com/profile/pashka>)
...
Idea: [ikrpprppp](<https://codeforces.com/profile/ikrpprppp>), prepared: [ikrpprppp](<https://codeforces.com/profile/ikrpprppp>)
...
If $y_a \gt y_b$ and Bob cannot reach right border ($w \gt y_b + t$), Alice can always choose the rightmost option for her and after each of $2t$ moves $y_a$ will be greater than $y_b$ which means Bob cannot win. Otherwise, if Bob always chooses the rightmost option for him, he will eventually achieve $y_a = y_b$.
...
Idea: [Vitaly239239](<https://codeforces.com/profile/Vitaly239239>), prepared: [Vitaly239239](<https://codeforces.com/profile/Vitaly239239>)
...
Idea: [Vitaly239239](<https://codeforces.com/profile/Vitaly239239>), prepared: [goncharovmike](<https://codeforces.com/profile/goncharovmike>)
