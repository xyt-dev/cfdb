...
To solve this problem we can count the number of digits 1, 2 and 3 in the input. If there are *c*<sub>1</sub> digits 1, *c*<sub>2</sub> digits 2 and *c*<sub>3</sub> digits 3. Then we must print the sequence of *c*<sub>1</sub> digits 1, *c*<sub>2</sub> digits 2 and *c*<sub>3</sub> digits 3. Digits must be separated by + sign.
