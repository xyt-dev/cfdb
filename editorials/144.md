...
Let's try to check all integer points of the table perimeter and add to the answer such of them that don't cover by circles of radiators. Let *x*<sub>*a*</sub> < *x*<sub>*b*</sub> and *y*<sub>*a*</sub> < *y*<sub>*b*</sub>, and if it's not true then swap *x*<sub>*a*</sub> and *x*<sub>*b*</sub>, *y*<sub>*a*</sub> and *y*<sub>*b*</sub>. So generals sit in the next integer points: (*x*<sub>*a*</sub>, *y*), (*x*<sub>*b*</sub>, *y*), (*x*, *y*<sub>*a*</sub>), (*x*, *y*<sub>*b*</sub>), where  *x*<sub>*a*</sub> ≤ *x* ≤ *x*<sub>*b*</sub> и *y*<sub>*a*</sub> ≤ *y* ≤ *y*<sub>*b*</sub>. We should be attentive when we count the generals who sits in points: (*x*<sub>*a*</sub>, *y*<sub>*a*</sub>), (*x*<sub>*a*</sub>, *y*<sub>*b*</sub>), (*x*<sub>*b*</sub>, *y*<sub>*a*</sub>), (*x*<sub>*b*</sub>, *y*<sub>*b*</sub>),  that don't count them twice.
