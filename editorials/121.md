...
Let generate all lucky number between 1 and 10^10^. Consider all segment [1;*L*0], [*L*0 + 1;*L*1], [*L*1 + 1;*L*2] ... Then the result equals to product of intersection of segments [1;*L*0] and [1;*n*] by *L*0 plus size of intersection of [*L*0 + 1;*L*1] and  [1;*n*] multiplied by *L*1 and so on.
