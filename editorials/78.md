...
![](eimages/78_3.png)
 ...
 lies inside circle of radius *R*" looks like *x*<sup>2</sup> + 3*y*<sup>2</sup> ≤ 4*R*<sup>2</sup>.
...
Complexity of this solution is *O*(*tn*<sup>4</sup> + *kn*<sup>6</sup>), where *k* is maximum possible number of scientists in each block(in this problem *k* = 9).
