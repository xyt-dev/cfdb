...
Solution complexity: *O*(*n*) / *O*(*n*<sup>2</sup>), depends on implementation.
...
Suppose that *i* ≠ *j*. Then the sum contains summands *A*<sub>*ij*</sub>*A*<sub>*ji*</sub> and *A*<sub>*ji*</sub>*A*<sub>*ij*</sub>. Since the sum is taken modulo 2, these summands together give 0 to the sum. It follows that the expression is always equal to the sum of the diagonal bits:
