...
## 952C - Ravioli Sort
Let's call the row of stacks "stable" if each adjacent pair of stacks in it differs in height by at most one (so no ravioli are going to slide to a different stack). It is easy to show that if a row is stable, then after removal of the tallest stack the resulting row is also stable. Indeed, after removing stack *a*<sub>*i*</sub> the only new pair of adjacent stacks is *a*<sub>*i* - 1</sub> and *a*<sub>*i* + 1</sub>. The row was stable, so |*a*<sub>*i*</sub> - *a*<sub>*i* - 1</sub>| ≤ 1 and |*a*<sub>*i*</sub> - *a*<sub>*i* + 1</sub>| ≤ 1. But *a*<sub>*i*</sub> was the tallest stack, so *a*<sub>*i*</sub> - 1 ≤ *a*<sub>*i* - 1</sub>, *a*<sub>*i* + 1</sub> ≤ *a*<sub>*i*</sub>. Thus the difference in height between *a*<sub>*i* - 1</sub> and *a*<sub>*i* + 1</sub> is at most 1, and the resulting row is also stable.
