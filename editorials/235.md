...
## 235B - Let's Play Osu!
Let us take a deep look at how this score is calculated. For an *n* long 'O' block, it contributes *n*<sup>2</sup> to the answer.
...
Proof of the claim: For an *n* long 'O' block, there are *C*<sub>*n*</sub><sup>2</sup> pairs of 'O' in it and *n* 'O' in it. Note that 2*C*<sub>*n*</sub><sup>2</sup> + *n* = *n*<sup>2</sup>.
...
. Then we denote P(j) as the sum of all event(i,j) for i<j. We have dp(0)=0 and dp(j)=(dp(j-1)+*p*<sub>*j* - 1</sub>)**p*<sub>*j*</sub>
## 235C - Cyclical Quest
...
So if we fixed the power of 2 in each *i*, *j*, *k* like 2<sup>*x*</sup>, 2<sup>*y*</sup>, 2<sup>*z*</sup>, then their upper limit becomes *a* / 2<sup>*x*</sup>, *b* / 2<sup>*y*</sup>, *c* / 2<sup>*z*</sup>, and the power of 2 in their multiplication is just x+y+z.
...
So we can do transform like this: *dp*(*a*, *b*, *c*, *p*) = sum of *dp*(*a* / *p*<sup>*x*</sup>, *b* / *p*<sup>*y*</sup>, *c* / *p*<sup>*z*</sup>, *q*)·(*x* + *y* + *z* + 1)
