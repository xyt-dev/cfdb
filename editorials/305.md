...
![](eimages/305_3.png)
 ...
 and then check equality of corresponding *a*~*i*~.

[Solution](<http://pastebin.com/x4rXtxen>)
## 305C - Ivan and Powers of Two
First of all, let's carry over all powers of two in the following way: if we have *a*~*i*~ = *a*~*j*~, *i* ≠ *j*, carry 1 to *a*~*i*~ + 1. Now as all of *a*~*i*~ are distinct, the answer is *max*(*a*~*i*~) — *cnt*(*a*~*i*~) + 1, where *max*(*a*~*i*~) — maximal value of *a*~*i*~,*cnt*(*a*~*i*~) — size of *a*
