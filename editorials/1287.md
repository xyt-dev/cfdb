<!-- url: https://codeforces.com/blog/entry/72867 -->
...
## 1286E - Fedya the Potter Strikes Back
...
- Add element $x$
- Remove element $x$
- For each element $a$ make $a = min(a, x)$
...
[Code](<https://pastebin.com/jLts7gVc>) (with BigInt realization)
