...
## 435D - Special Grid
Values *n* and *m* are not so large, so the solution with complexity *O*(*max*(*n*, *m*)<sup>3</sup>) should pass. It means that you should consider all triangles and check all conditions in *O*(1).
