<!-- url: https://codeforces.com/blog/entry/106553 -->
Problem A. Idea by [Igorbunov](<https://codeforces.com/profile/Igorbunov>)
...
Let $d = gcd(a, b)$. Now notice that it's impossible that $a = k \cdot d$ for some $k \gt 4$, because otherwise $lcm$ will be at least $k \cdot d \gt 3 \cdot d$. Therefore the only possible cases are the pairs listed above and $(2 \cdot d, 3 \cdot d)$, but in the latter case we have $lcm = 6 \cdot d$.
...
Problem B. Idea by [FairyWinx](<https://codeforces.com/profile/FairyWinx>)
...
Problem C. Idea by [FairyWinx](<https://codeforces.com/profile/FairyWinx>)
...
Problem D. Idea by [FairyWinx](<https://codeforces.com/profile/FairyWinx>)
...
Problem E. Idea by [FairyWinx](<https://codeforces.com/profile/FairyWinx>)
...
Problem F. Idea by [TeaTime](<https://codeforces.com/profile/TeaTime>), tutorial by [purplesyringa](<https://codeforces.com/profile/purplesyringa>)
