...
 Consider the number, that is our answer and factorize it. We will get such product *p*~1~^*a*~1~^· *p*~2~^*a*~2~^· ... · *p*~*k*~^*a*~*k*~^. Product through each i *a*~*i*~ + 1 will be the number of divisors. So, if we will take first 10 prime numbers, their product will have 1024 divisors. This means that we need only first 10 primes to build our answer.
