...
, then *a*<sub>*i*</sub> = *b*<sub>*i*</sub>, so we have one possibility: *a*<sub>*i*</sub> = *b*<sub>*i*</sub> = *a*<sub>*i*</sub>&*b*<sub>*i*</sub>. If

![](eimages/627_7.png)

, then we must have *a*<sub>*i*</sub>&*b*<sub>*i*</sub> = 0 (otherwise we print 0), and we have two choices: *a*<sub>*i*</sub> = 1 and *b*<sub>*i*</sub> = 0 or vice versa. Thus, we can return 2<sup>*n*</sup>, where *n* is the number of one-bits in *x*. (Remember to subtract 2 for the cases *a* = 0 or *b* = 0 if necessary.)
