...
**B div2.** Naive solution *O*(*n*^3^) (where you check all triplets) doesn't fin into time limits.
...
Obtained solution works in *O*(*n*^2^).
...
Let's sort all *k* vertices in order of dfs traversal — *v*~1~, *v*~2~, ... , *v*~*k*~. Consider pathes v1-v2, v2-v3, ... , v(k-1)-vk and vk-v1. You can see that they cover only our requred subtree and every edge is covered exactly two times. So you can just find sum of lengths of these pathes (you can do it in required
