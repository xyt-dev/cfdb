...
We will count value *ans*<sub>*i*</sub> — number of different elements on the suffix from *i*. For calculation will walk from the end of the array, and we count *ans*<sub>*i*</sub> = *ans*<sub>*i* + 1</sub> + *new*<sub>*a*<sub>*i*</sub></sub>, *new*<sub>*a*<sub>*i*</sub></sub> equals to 1, if element *a*<sub>*i*</sub> has not yet met and 0 otherwise.
