...
There is another shorter solution: let's notice that order of jars doesn't matter. Let's see how much honey from each jar will be eaten by Winnie and how much will be left to Piglet. If *a*~*i*~ ≥ 3*k* then Winnie will leave *a*~*i*~ - 3*k* kg of honey to Piglet. If *a*~*i*~ < 3*k* then he'll leave only
