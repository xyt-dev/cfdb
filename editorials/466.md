...
Otherwise, we have to increase one of the walls(maybe, both). Let’s do it in the following way: iterate the size of the smallest wall *new*<sub>*a*</sub> (
...
.
 For all this *new*<sub>*a*</sub> and *new*<sub>*b*</sub> if *b* ≤ *new*<sub>*b*</sub> we choose such a pair that has the smallest area of a room.
